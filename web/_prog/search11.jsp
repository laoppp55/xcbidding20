...
<head>
    ...
    <meta content="" name="keywords" />
    <link rel="stylesheet" type="text/css" href="/css/theory.css" /><style type="text/css">
    .fenye li{float:left;}</style>
</head>
<body>
<div class="main">
    <div class="box"><%@include file="/inc/head.shtml" %><div class="banner"><img alt="" src="/images/banner61.jpg" /></div>
        ...
        </div><%@include file="/inc/footer.shtml" %><div class="clear"></div>
    </div>
</div>
