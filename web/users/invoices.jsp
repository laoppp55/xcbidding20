...
<div class="con_box">
    <div class="personal_left">
        ...
        <ul>
            <li><a href="/users/m/personinfo.jsp">我的订单</a></li>
            <li><a href="/users/m/changepersoninfo.jsp">修改注册信息</a></li>
            <li><a href="/users/m/changePwd.jsp">修改密码</a></li>
            <li><font color="red">发票信息</font></li>
