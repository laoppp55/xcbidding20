    ...
    <div class="personal_right_box">
        <table id="projectsid" width="1000" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" style="margin-top:25px;">
            ...
            <tr <%=((ii % 2)==0)?"bgcolor=\"#ffffff\"":"bgcolor=\"#ffffff\""%>>
                ...
                <%if(multiNoticeFlag) {%>
                <td><a href="javascript:downfile('<%=bidderInfo.getPurchaseprojcode()%>');">下载</a></td>
                <%} else {%>
                <td><a href="<%=MyConstants.getDownloadAddress()%>/oa/common/attachment/publicDownloadFile?id=<%=bulletinNotices.get(0).getReceiveFile()%>">下载</a></td>
                <%}%>
            </tr>
            <%}%>
        </table>
