...
function checkImageFileExt(filename) {
    var flag = false; //状态
    var arr = ["jpg","jpeg","png","gif","JPG","JPEG","PNG","GIF"];
    //取出上传文件的扩展名
    var index = filename.lastIndexOf(".");
    var ext = filename.substr(index+1);
    //循环比较
...
function checkBidApplicationInfo(form) {
    ...
    if (idcardpic_frontfile==null || idcardpic_frontfile=="" || idcardpic_frontfile=='' || typeof idcardpic_frontfile == "undefined") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'投标联系人身份证正面图片不能为空，请上传身份证正面图片'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
        ...
        var result = checkImageFileExt(idcardpic_frontfile);
        if (result.pass == false) {
            $.msgbox({
                height:120,
                width:300,
                content:{type:'alert', content:'投标联系人身份证正面图片文件格式错，必须上传jpg、jpeg或者png扩展名的图片'},
                animation:0,        //禁止拖拽
                drag:false          //禁止动画
                //autoClose: 10       //自动关闭
            });
    ...
    //检查上传营业执照的图片格式是否正确
    var licensepic = form.licensepic.value;
    if (licensepic==null || licensepic=="" || licensepic=='' || typeof licensepic == "undefined") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'营业执照图片不能为空，请上传营业执照图片'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
        ...
        if (result.pass == false) {
            $.msgbox({
                height:120,
                width:300,
                content:{type:'alert', content:'上传的营业执照图片文件格式错，必须上传jpg、jpeg或者png扩展名的图片'},
                animation:0,        //禁止拖拽
                drag:false          //禁止动画
                //autoClose: 10       //自动关闭
            });
    ...
    //检查授权委托书图片格式是否正确
    var authletterpic = form.authletterpic.value;
    if (authletterpic==null || authletterpic=="" || authletterpic=='' || typeof authletterpic == "undefined") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'授权委托书图片不能为空，请上传授权委托书图片'},
            animation:0,        //禁止拖拽
            drag:false          //禁止动画
            //autoClose: 10       //自动关闭
        });
        ...
        if (result.pass == false) {
            $.msgbox({
                height:120,
                width:300,
                content:{type:'alert', content:'上传授权委托书图片文件格式错，必须上传jpg、jpeg或者png扩展名的图片'},
                animation:0,        //禁止拖拽
                drag:false          //禁止动画
                //autoClose: 10       //自动关闭
            });
    ...
    if (lawPersonTel==null || lawPersonTel=="" || lawPersonTel=='' || typeof lawPersonTel == "undefined") lawPersonTel="";
    var idcardpic_backfile = form.idcardpic_backfile.value;
    if (idcardpic_backfile==null || idcardpic_backfile=="" || idcardpic_backfile=='' || typeof idcardpic_backfile == "undefined") idcardpic_backfile="";
    var otherpic = form.otherpic.value;
    if (otherpic==null || otherpic=="" || otherpic=='' || typeof otherpic == "undefined") otherpic="";
...
function checkvalid(form,actionflag) {
    ...
    if (bankname == null || (typeof bankname == "undefined") || bankname == "") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'供应商开户行信息不能为空，请填写供应商开户银行'},
            animation:0,       //禁止拖拽
            drag:false         //禁止动画
            //autoClose: 10     //自动关闭
        });
    ...
    if (BaseAccountName == null || (typeof BaseAccountName == "undefined") || BaseAccountName == "") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'供应商基本账户名信息不能为空，请填写供应商基本账户名信息'},
            animation:0,       //禁止拖拽
            drag:false         //禁止动画
            //autoClose: 10     //自动关闭
        });
    ...
    if (baseAccount == null || (typeof baseAccount == "undefined") || baseAccount == "") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'供应商基本账号信息不能为空，请填写供应商基本账号信息'},
            animation:0,       //禁止拖拽
            drag:false         //禁止动画
            //autoClose: 10     //自动关闭
        });
    ...
    if (businessBrief == null || (typeof businessBrief == "undefined") || businessBrief == "") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'供应商经营范围信息不能为空，请按照营业执照填写供应商经营范围'},
            animation:0,       //禁止拖拽
            drag:false         //禁止动画
            //autoClose: 10     //自动关闭
        });
    ...
    if (operationAddress == null || (typeof operationAddress == "undefined") || operationAddress == "") {
        $.msgbox({
            height:120,
            width:300,
            content:{type:'alert', content:'供应商经营地址信息不能为空，请按照营业执照填写供应商经营地址'},
            animation:0,       //禁止拖拽
            drag:false         //禁止动画
            //autoClose: 10     //自动关闭
        });
