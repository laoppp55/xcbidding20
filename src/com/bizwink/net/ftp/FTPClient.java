...
public class FTPClient {
     ...
     *  Revision control id
     */
    private static String cvsId = "$Id: FTPClient.java,v 1.1.1.1 2006/07/18 08:31:33 ericdu Exp $";
    ...
    public void mkdir(String dir)
        ...
        //在这儿，我们认为如果该目录已经存在，MKDIR抛出的异常并不是我们认为的
        //错误，故返回状态是550我们也认为是正确的，者相当的重要
        String[] validCodes2 = {"550", "257","521"};
        control.validateReply(reply, validCodes2);
