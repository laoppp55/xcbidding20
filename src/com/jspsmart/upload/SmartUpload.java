...
public class SmartUpload
{
    ...
    public void upload() throws SmartUploadException, IOException, ServletException
    {
        ...
        if (m_totalBytes != -1) {
            ...
            try{
                if(m_totalBytes>593920000 || m_totalBytes<0)    //500M
            ...
            for(; totalRead < m_totalBytes; totalRead += readBytes) {
                try {
                    ...
                    e.printStackTrace();
                    m_binArray = null;
                    m_request.getInputStream().close();
                    m_request = null;
                }
            }
            ...
            do {
                ...
                if(isFile)
                {
                    ...
                    String value = new String(m_binArray,m_startData,(m_endData - m_startData) + 1,(this.getCharset()==null)?"utf-8":this.getCharset());
    ...
    private String getDataHeader()
    {
        ...
        try {
            if (this.getCharset()!=null)
                dataHeader = new String(m_binArray, start, (end - start) + 1,this.getCharset());
            else
