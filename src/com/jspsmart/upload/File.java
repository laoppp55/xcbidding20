...
public class File {
	...
	private SmartUpload m_parent;             //important
	...
	/**
	 * Get the byte array data of the upload file
	 * use to save the file in Database
	 * By Philliy Chung (ZhongPu), 2003.2
	 * @return the file byte[] data
	 */

	public byte[] getByteArrayData() {
		byte[] data = new byte[m_size];
		System.arraycopy( m_parent.m_binArray, m_startData, data, 0, m_size );
		return data;
	}
}
