...
strFrame+='         Author=meizz title="' + _VersionInfo + '"><u>关闭</u></span><span onclick=parent.a()>手动填写年</span>&nbsp;</td></tr>';
...
function a()
{
  ...
  var s = "parent.meizzYearHead ='1222'";
  var selectInnerHTML = "<input type=text size=4  onDblClick='document.all.tmpSelectYearLayer.style.display=\"none\";parent.meizzTheYear = this.value; parent.meizzSetDay(parent.meizzTheYear,parent.meizzTheMonth)'>";
