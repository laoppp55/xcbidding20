						...
						<tr>
							<td>
								<table border="0" cellpadding="5" cellspacing="0" class="header">
									...
									<tr>
										<td>连接数据库超级用户：</td><td><input type="text" name="dbCreateUser" size="8" style="width:120px;" value='<%= Bean.getDbCreateUser() %>'></td><td><input type="text" name="dbCreatePwd" size="8" style="width:120px;" value='<%= Bean.getDbCreatePwd() %>'></td>
									</tr>
									<%
									...
									<b><font color="FF0000">Warning:</font></b><b> 警告:</b> 已存在的数据库会被删除！<br></td></tr>

								</table>
							</td>
						</tr>
						<tr><td align="center"><b>注意:</b> 您必须在你的 /lib目录中存在sql server驱动程序!</td></tr>
