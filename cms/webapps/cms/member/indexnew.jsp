...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">CMS-用户管理</div>
            ...
            <table width="100%" border="0" cellspacing="10" cellpadding="0">
                ...
                <tr>
                    <td align="left" valign="top">
                        <table width="100%" border="1" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC" class="tab_list">
                            <tr>
                                <td width="50" align="center" valign="middle" bgcolor="#f4f4f4">
                                    <input type="checkbox" name="selall" id="selallid" />选择
                                </td>
                                <td width="30" align="center" valign="middle" bgcolor="#f4f4f4">序号</td>
                                <td width="73" align="center" valign="middle" bgcolor="#f4f4f4">用户名</td>
                                <td width="87" align="center" valign="middle" bgcolor="#f4f4f4">真实姓名</td>
                            ...
                            <%
                                ...
                                for(int ii=0;ii<users.size();ii++) {
                                    ...
                                    String mphone = (user.getMPHONE()!=null)?user.getMPHONE():"";
                                    String sex = (user.getSEX().intValue()==1)?"女":"男";
                                    String company = (user.getCOMPANY()!=null)?user.getCOMPANY():"";
                                    String dept = (user.getDEPARTMENT()!=null)?user.getDEPARTMENT():"";
                                    String createdate = (user.getCREATEDATE()!=null)?dateFormat.format(user.getCREATEDATE()):"";
                            %>
                            <tr bgcolor="#FFFFFF" id="row<%=user.getID()%>">
                                <td align="center" valign="middle"><input type="checkbox" name="selitem" id="selitem<%=user.getID()%>" /></td>
                                <td align="center" valign="middle"><%=user.getID()%></td>
                                <td align="center" valign="middle"><%=user.getUSERID()%></td>
                                <td><%=nickname%></td>
                                <td><%=email%></td>
                                ...
                                <td align="center" valign="middle"><a href="javascript:deluser(<%=user.getID()%>);"><img src="../images/del.png" width="23" height="23" /></a></td>
                                <td align="center" valign="middle">
                                    <a href="javascript:updateuser(<%=user.getID()%>,'<%=user.getUSERID()%>','<%=nickname%>');"><img src="../images/edit.png" width="24" height="23" /></a>
                                </td>
                                <td align="center" valign="middle"><a href="javascript:forbiduser(<%=user.getID()%>);"><img src="../images/public.png" width="23" height="23" /></a></td>
                            </tr>
                            <%}%>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="70%">用户总数：<%=users.size()%>&nbsp;&nbsp;&nbsp;&nbsp;总1页&nbsp;&nbsp;&nbsp;第一页 到第<input type="text" name="textfield" id="textfield"  class="txt_1"/>
                                    <input type="submit" name="button2" id="button2" value="GO" class="btn_go" /></td>
                            </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="23%" height="50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标题：<input type="text" name="textfield2" id="textfield2" class="sear_txt_1"/>&nbsp;
                                    <input type="submit" name="button3" id="button3" value="搜索" class="sear_btn"/> <a href="#" class="sear_gj">高级搜索</a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
