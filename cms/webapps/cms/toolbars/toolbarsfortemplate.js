...
function TBLayoutBodyElement() {
  ...
  //tbContentElementObject.style.posHeight = 200;
  //tbContentElementObject.style.width = (2/3)* (document.body.offsetWidth);
  ...
  //submittable.style.posTop = tbContentElementTop + 260;
  /* submittable.style.posTop = tbContentElementBottom+10;
  submittable.style.left = 80;
  submittable.style.visibility ="visible"; */
  //forTemplate.style.left = tbContentElementObject.style.width+40;
  //forTemplate.style.visibility ="visible";
...
function windowResize() {
  ...
  //-----------------------------------------------------
  //here is write by zhangyong
  bottomofFld = document.body.all["bottomofFld"].offsetTop+2;
