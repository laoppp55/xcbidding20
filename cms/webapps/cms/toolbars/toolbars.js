...
function TBLayoutBodyElement() {
  ...
  tbContentElementObject.style.posHeight = 525;
  tbContentElementObject.style.width = 1 * (document.body.offsetWidth)-16;
  ...
  //submittable.style.posTop = tbContentElementTop + 460;
