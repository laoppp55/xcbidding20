    ...
    <div class="layui-side layui-bg-gray">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree layui-bg-gray"  lay-filter="test">
                ...
                <li class="layui-nav-item"><a href=""><span style="color:black" class="layui-icon-camera">采编人员信息发布量统计</span></a></li>
...
<script>
    ...
    function statisticsByCol() {
        ...
        htmlStr = htmlStr + '<input type="text" name="endday" value="" /></br></br>';
