...
<%
  ...
  if(startflag == 1){
    ...
    addresslistMgr.insertAddressList(addresslist);
    response.sendRedirect("list.jsp");
  }
%>
<HTML><HEAD><TITLE>联系人信息录入</TITLE>
...
borderColorLight=#008000 border=1>
  ...
  <TR>
    <TD bgColor=#33ccff colSpan=2 height=32>
      <P align=center>添加联系人信息</P></TD></TR>
  <TR height=32>
    <TD align=right width=30% height=32>联系人姓名：</TD>
    <TD align=left width=70% height=32>&nbsp;<INPUT name=username> <FONT
      color=red>*</FONT> </TD></TR>
  <TR height=32>
    <TD align=right>公司名称：</TD>
    <TD align=left>&nbsp;<INPUT size=50 name=company>
  </TD></TR>
  <TR height=32>
    <TD align=right>地址：</TD>
    <TD align=left>&nbsp;<INPUT size=50 name=address> </TD></TR>
  <TR height=32>
    <TD align=right>邮编：</TD>
    <TD align=left>&nbsp;<INPUT size=13 name=postcode>
  </TD></TR>
  <TR height=32>
    <TD align=right>手机：</TD>
    <TD align=left>&nbsp;<INPUT name=mobilephone> </TD></TR>
  <TR height=32>
  ...
  <TR height=32>
    ...
    <TD align=left>&nbsp;<INPUT size=16 name=fax> </TD></TR>
  <TR height=32>
    <TD align=right>电子邮件：</TD>
    <TD align=left>&nbsp;<INPUT size=50 name=email> </TD></TR>
  <TR height=32>
    <TD colSpan=2><FONT
