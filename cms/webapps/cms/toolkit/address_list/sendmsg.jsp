...
<%
  ...
  list = addresslistMgr.getMessageList1(memberid);
  currentlist = addresslistMgr.getCurrentMessageList1(memberid,startrow,range);
...
function DelMessage(id)
{
    ...
    if (bln)
    {
	    window.location = "deletemessage.jsp?id="+id+"&flag=2";
    }
}
...
borderColorLight=#008000 border=1>
  ...
  <TR height=35>
    ...
    <TD align=middle width="8%">接收者</TD>
