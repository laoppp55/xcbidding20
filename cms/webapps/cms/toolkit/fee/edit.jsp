...
<%
    ...
    if(startflag == 1){
        ...
        int errcode = oMgr.updateAFeeInfo(feeinfo);
        if(errcode == 0){
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="css_002">
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">送货方式名称</td>
                    <td align="left" width="50%"><input type="text" name="cname" value="<%=ofee.getCname()==null?"":StringUtil.gb2iso4View(ofee.getCname())%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">送货方式描述</td>
                    <td align="left" width="50%"><textarea rows="5" cols="20" name="notes"><%=ofee.getNotes()==null?"":StringUtil.gb2iso4View(ofee.getNotes())%></textarea> </td>
                </tr>
                  <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">运费(如果免费请填写“0”)</td>
                    <td align="left" width="50%"><input type="text" name="fee" value="<%=ofee.getFee()%>"> </td>
                </tr>
               </table>
            </td>
          </tr>
