...
<form id="uploadForm" name="Form" action="uploadpic.jsp?doUpload=1" method="post" enctype="multipart/form-data">
    <table border="0" cellspacing="1" class="fu_list">
        ...
        <tr>
            <td colspan="2" style="color:gray">温馨提示：最多可同时上传 <b id="idLimit"></b> 个文件且单个文件大小最大为1M，只允许上传 <b id="idExt"></b> 文件。 </td>
        </tr>
        <tr>
            <td colspan="2" align="center" id="idMsg"><input type="submit" value="开始上传" id="idBtnupload" disabled="disabled" />
                ...
                &nbsp;&nbsp;&nbsp;
                <input type="button" value="  关闭  " class=tine onClick="cal();">
            </td>
        </tr>
        </tbody>
    </table>
...
FileUpload.prototype = {
    ...
    SetOptions: function(options) {
        this.options = {//默认值
            ...
            FrameName:	"cmsright",//iframe的name，要自定义iframe的话这里设置name
            ...
            ExtIn:		["gif","jpg","jpeg","png","png","swf"],//允许后缀名
...
var fu = new FileUpload("uploadForm", "idFile", {
    ...
    onLimite: function(){ alert("超过最多上传限制"); },
...
$("idBtnupload").onclick = function(){
    ...
    $("idMsg").innerHTML = "正在添加文件，请稍候……<br />有可能因为网络问题，出现程序长时间无响应，请点击“<a href='?'><font color='red'>取消</font></a>”重新上传文件";
