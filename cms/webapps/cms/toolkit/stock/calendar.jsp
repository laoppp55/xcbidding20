<%@ page import = "java.sql.*,
                   java.util.*,
                   java.text.*,
		   com.sinopec.calendar.*" contentType="text/html;charset=gbk"%>
...
<link rel=stylesheet href="/inc/calendar.css" style="text/css">
<script language=JavaScript1.2 src="/inc/public.js"></script>
<script language=JavaScript1.2 src="/inc/functions.js"></script>
</head>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
    <tr align="center">
	<td bgcolor="#FFAD0C">
            <a href="calendar.jsp?d=<%=formatter.format(dateDebut)%>&form=<%=formName%>&ip=<%=ip%>"><img src="/images/parrow.gif" width="18" height="20" align="absmiddle" border=0 alt="上个月"></a>
	    <%=smartDate.getYear(dateSelected)%>年<%=smartDate.getMonth(dateSelected)%>月
	    <% dateDebut = smartDate.addMonth(dateSelected, 1); %>
	    <a href="calendar.jsp?d=<%=formatter.format(dateDebut)%>&form=<%=formName%>&ip=<%=ip%>"><img src="/images/narrow.gif" width="18" height="20" align="absmiddle" border=0 alt="下个月"></a>
        </td>
    </tr>
