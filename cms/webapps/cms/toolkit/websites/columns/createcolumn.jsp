...
<%
    ...
    companyType = websiteManager.getCompanyClass(parentID);
    ...
    if (!errors && doCreate) {
        boolean dualName = websiteManager.duplicateEnName(parentID, EName);
        if (!dualName) {
            try {
                ...
                websiteManager.create(companyType);
                success = true;
            }
    ...
    //获得首页文件扩展名
    String extname = websiteManager.getIndexExtName(siteid);
%>
