...
function gotodo(val){
  tehuiForm.action = "dotehui.jsp?flag="+val;
  tehuiForm.submit();
}
...
function gotoSearch(r,p){
  ...
  SearchForm.action = "tehui.jsp?searchflag=1";
  SearchForm.submit();
...
function editflag(id) {
  window.open( "edittehui.jsp?id="+id,"","top=100,left=100,width=400,height=200,resizable=no,scrollbars=no,status=no,toolbar=no,menubar=no,location=no");
}
function jumppage(r,str){
  tehuiForm.action = "tehui.jsp?startrow="+r+str;
  tehuiForm.submit();
}
function golistnew(r){
  tehuiForm.action = "tehui.jsp?startrow="+r;
  tehuiForm.submit();
}
</script>
</head>
...
<form method="post" action="dotehui.jsp" name="tehuiForm">
<input type="hidden" name="flag" value="1">
      ...
      <td>
        <table width="100%" border="0" cellpadding="0">
          <tr bgcolor="#F4F4F4" align="center">
            <td class="moduleTitle"><font color="#48758C">特惠图书管理</font></td>
          </tr>
            ...
            <td>
              <table width="100%" border="0" cellpadding="2" cellspacing="1">
                ...
                for(int i=0;i<currentlist.size();i++){
                  ...
                  bookname2 = search.getBookName();
                  bookname2 = new String(bookname2.getBytes("iso8859_1"),"GBK");
                  author2 = search.getAuthor();
                  author2 = new String(author2.getBytes("iso8859_1"),"GBK");
                  publisher2 = search.getPublisher();
                  publisher2 = new String(publisher2.getBytes("iso8859_1"),"GBK");
  ...
  <input type="button" value="实行特惠" onclick="javascript:gotodo(1);">
  <input type="button" value="取消特惠" onclick="javascript:gotodo(0);">
...
<%
  if(searchflag == 0){
    if((startrow-range)>=0){
%>
[<a href="tehui.jsp?startrow=<%=startrow-range%>">上一页</a>]
<%}%>
<%
  if((startrow+range)<rows){
%>
[<a href="tehui.jsp?startrow=<%=startrow+range%>">下一页</a>]
<%}
 if(totalpages>1){%>
...
<%}
    ...
    if((startrow-range)>=0){
%>
  [<a href="tehui.jsp?startrow=<%=startrow-range%><%=jumpstr%>">上一页</a>]
  <%}
    if((startrow+range)<rows){
  %>
  [<a href="tehui.jsp?startrow=<%=startrow+range%><%=jumpstr%>">下一页</a>]
  <%}
 if(totalpages>1){
