...
<form action="edit.jsp" method="post" name="annoForm">
      ...
      <td>
        <table width="100%" border="0" cellpadding="0">
          <tr bgcolor="#F4F4F4" align="center">
            <td class="moduleTitle"><font color="#48758C">修改专题</font></td>
          </tr>
          <tr bgcolor="#d4d4d4" align="right">
            <td>
                <table width="100%" border="0" cellpadding="2" cellspacing="1">
                  <tr bgcolor="#FFFFFF">
                    <td>专题名称：</td>
                    <td> <input type="text" name="title" size="80" value="<%=other.getZTName()==null?"":new String(other.getZTName().getBytes("iso8859_1"),"GBK")%>"> <font color="#FF0000">&nbsp;
                      </font> </td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td name="title">专题描述：</td>
                    <td>
                      <textarea rows="18" cols="90" name="content"><%=other.getZTDesc()==null?"":new String(other.getZTDesc().getBytes("iso8859_1"),"GBK")%></textarea>
                    </td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td>上传图片：</td>
