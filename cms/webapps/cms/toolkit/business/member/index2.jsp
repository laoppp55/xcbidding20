...
<head>
    ...
    <script language="javascript">
        ...
        function exportOrders(){
            ...
            window.open('exportMembersToExcel.jsp', '', 'height=' + iHeight + ', width=' + iWidth + ', top=' + iTop + ', left=' + iLeft + ', toolbar=yes, menubar=no, scrollbars=yes, resizable=no, location=no, status=yes');
        }
