...
function AddRelatedArticleID(columnid)
{
    ...
    var retval;
    if (isMSIE) {
        retval = showModalDialog("../article/addRelatedArticle.jsp?column="+columnid, "AddRelatedArticleID", "font-family:Verdana; font-size:12; dialogWidth:55em; dialogHeight:35em; status=no");
