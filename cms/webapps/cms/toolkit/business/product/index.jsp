...
<frameset cols=160,* border=0 frameborder=0 framespacing=0>
    <frameset frameborder=0 framespacing=0 border=0 cols=* rows=0,*>
        <frame src="columntree.jsp?rightid=<%=rightid%>&tid=<%=id%>" name=cmsleft scrolling=auto marginheight=0 marginwidth=0>
        <frame marginwidth=5 marginheight=5 src="menu.html" name=menu scrolling=auto frameborder=0>
    </frameset>
    <frame src=productmain.jsp name=cmsright scrolling=auto marginheight=0 marginwidth=5>
</frameset>
</html>
