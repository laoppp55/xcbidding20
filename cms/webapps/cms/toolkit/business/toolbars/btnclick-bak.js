...
function checkoption(para,para1) {
  ...
  */
  ...
  optionsname[0][5] ="留言本";
  optionsname[0][6] ="计数器";
  optionsname[0][7] ="热点文章";
  optionsname[0][8] ="文章属性";
  ...
  optionsvalue[0][5] ="MESSAGE_BOARD";
  optionsvalue[0][6] ="SITE_COUNTER";
  optionsvalue[0][7] ="TOP_STORIES";
  optionsvalue[0][8] ="ARTICLE_PROPERTIES";
  ...
  optionsname[1][13] ="文章评论";
  optionsname[1][14] ="文章推荐";
  optionsname[1][15] ="留言簿";
  ...
  optionsvalue[1][13] ="ARTICLE_COMMENT";
  optionsvalue[1][14] ="ARTICLE_COMMEND";
  optionsvalue[1][15] ="MESSAGE_BOARD";
