...
<%
    ...
    if (searchflag == 0) {
        list = orderMgr.getOrderList(startrow, 0, 5, "");
        currentlist = orderMgr.getOrderList(startrow, range, 5, "");
    ...
    if (searchflag != 0) {
        ...
        sqlstr = "select o.* from tbl_orders o where o.siteid=" + siteid + " and o.status=5 and 1 = 1";
...
<form action="refuse.jsp" method="post" name="chuku">
...
<table border="0" cellspacing="0" cellpadding="4" bgcolor="#FFFFFF">
        ...
        <td>
            <table width="100%" border="0" cellpadding="0">
                <tr bgcolor="#F4F4F4" align="center">
                    <td class="moduleTitle"><font color="#48758C">拒收订单列表</font></td>
                </tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="2" cellspacing="1">
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td align="center"><%=StringUtil.gb2iso4View(order.getProvince())%>
                                </td>
    ...
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="chkAll" value="on"
                                           onclick="javascript:CheckAll(this.form);">全部选中
        </td>
    </tr>
</table>
<table>
