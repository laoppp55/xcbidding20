...
<%
    ...
    if (updateflag == 1) {
        ...
        for (int i = 0; i < ordergo.length; i++) {
            updateid = Integer.parseInt(ordergo[i]);
    ...
    if (searchflag == 0) {
        String sql = "select o.* from en_orders o where o.siteid = " + siteid + " and o.status=3 and nouse = 1 order by o.createdate desc";
    ...
    if (searchflag != 0) {
        ...
        sqlstr = "select o.* from en_orders o where o.status=3 and o.siteid = " + siteid + " and 1 = 1";
        ...
        <td>
            <table width="100%" border="0" cellpadding="0">
                <tr bgcolor="#F4F4F4" align="center">
                    <td class="moduleTitle"><font color="#48758C">已审核订单列表</font></td>
                </tr>
...
<input type="submit" value="已发货" onclick="javascript:return check(this.form);">
<table>
    <tr valign="bottom">
        <td>
