    ...
    if(searchflag != 0){
      ...
      if((booknames != "")&&(booknames != null)){
       if(!booknames.equals("null")){
        if(sqlstr.endsWith("1 = 1"))
          ...
          sqlstr = sqlstr + " or bookname like '@" + booknames + "@'";
       }
      }
      ...
      if((authors != "")&&(authors != null)){
       if(!authors.equals("null")){
        if(sqlstr.endsWith("1 = 1"))
          ...
          sqlstr = sqlstr + " or author like '@" + authors + "@'";
       }
      }
      ...
      if((publishers != "")&&(publishers != null)){
       if(!publishers.equals("null")){
        if(sqlstr.endsWith("1 = 1"))
          ...
          sqlstr = sqlstr + " or publisher like '@" + publishers + "@'";
       }
      }
      ...
      if((pinxiangs != 0)){
        if(sqlstr.endsWith("1 = 1"))
          ...
          sqlstr = sqlstr + " or pinxiang like '@" + pinxiangs + "@'";
      }
      ...
      if((types != "")&&(types != null)){
       if(!types.equals("null")){
        if(sqlstr.endsWith("1 = 1"))
          ...
          sqlstr = sqlstr + " or book_type_id like '@" + types + "@'";
       }
      }
...
function jumppage(r,str){
  tehuiForm.action = "index.jsp?startrow="+r+str;
  tehuiForm.submit();
}
function golistnew(r){
  tehuiForm.action = "index.jsp?startrow="+r;
  tehuiForm.submit();
}
</script>
</head>
            ...
            <td>
              <table width="100%" border="0" cellpadding="2" cellspacing="1">
                ...
                <tr  bgcolor="#FFFFFF">
                  ...
                  <td align="center"><%=recommend_type%></td>
                  <td align="center"><a href="recommend.jsp?bookid=<%=bookid%>"><%=bookname%></a></td>
