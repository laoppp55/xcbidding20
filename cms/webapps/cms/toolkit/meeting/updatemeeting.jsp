...
<%
    ...
    Meettings meettings=CompanyinfoMgr.getMeeting(id);
    String meetingnames = meettings.getMeetingname();
    String meetingdatetimes=meettings.getMeetingdatetime().toString();
    String addresss = meettings.getAddress();
    ...
    if (startflag == 1) {
        ...
        try {
            ...
            CompanyinfoMgr.updateMeeting(id,meettings);
        ...
        <tr>
            <td height="360" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <form method="POST" action="updatemeeting.jsp" name="addForm" onsubmit="javascript:return checkSurvey();">
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;<input type="text" name="meetingname" size="50" value="<%=meetingnames==null?"":meetingnames%>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="1" bgcolor="#898898"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1" bgcolor="#898898"></td>
                                        <td>
                                            &nbsp;&nbsp;<input id="beginTime"  value="<%=meetingdatetimes.substring(0,10)%>" type="text" onfocus="WdatePicker({el:'beginTime',dateFmt:'yyyy-MM-dd'});" class="Wdate" name="meetingdatetime" size="50" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="1" bgcolor="#898898"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1" bgcolor="#898898"></td>
                                        <td>
                                            &nbsp;&nbsp;<input type="text" name="address" size="50" value="<%=addresss==null?"":addresss%>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="1" bgcolor="#898898"></td>
