...
<%
    ...
    String sqlstr = "";
    if (seltype == 1) {
        sqlstr = "select * from tbl_purchasedetail where Purchaseid like '@" + querystr + "@' and siteid = '" + siteid + "'";
    } else if (seltype == 2) {
        sqlstr = "select * from tbl_purchasedetail where Productid like '@" + querystr + "@' and siteid = '" + siteid + "'";
    }

    //list = pmMgr.getAllProduct();
    currentlist = pudMgr.getCurrentQureyPurchaseDetailList(sqlstr, startrow, range);
...
<BODY>
<P align=right><FONT color=#0000ff><a href="purchasedetail.jsp">返回</a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <TABLE cellSpacing=0 borderColorDark=#ffffff cellPadding=0 width="98%"
        ...
        <TR height=35>
            ...
            <TD align=middle width="5%">
                <A href="purchasemaster.jsp#" onclick="javascript:return DelSupplier(<%=id%>);">
