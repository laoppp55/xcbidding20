...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'DocProps'			: oItem = new FCKToolbarButton( 'DocProps'	, FCKLang.DocProps, null, null, null, null, 2 ) ; break ;
                case 'Open'			: oItem = new FCKToolbarButton( 'Open'		, FCKLang.Open, null, FCK_TOOLBARITEM_ICONTEXT, true, null, 3 ) ; break ;
		...
		case 'ShowBlocks'		: oItem = new FCKToolbarButton( 'ShowBlocks'	, FCKLang.ShowBlocks, null, null, null, true, 72 ) ; break ;
                case 'Multimedia'       	: oItem = new FCKToolbarButton( 'Multimedia'	, FCKLang.Multimedia, null, null, null, null, null) ; break ;       //多媒体文件上传
        
                case 'InsertFile'	        : oItem = new FCKToolbarButton( 'InsertFile'	, FCKLang.InsertFile, null, null, null, null, null) ; break ;
