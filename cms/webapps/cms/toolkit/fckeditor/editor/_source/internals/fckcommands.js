...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'Source'		    : oCommand = new FCKSourceCommand() ; break ;
                case 'Open'           : oCommand = new FCKOpenCommand();   break;    
        ...
        case 'ImageButton'      : oCommand = new FCKHispicCommand(); break;
        case 'Multimedia'       : oCommand = new FCKMultimediaCommand(); break;
        case 'InsertFile'       : oCommand = new FCKInsertFileCommand(); break;
