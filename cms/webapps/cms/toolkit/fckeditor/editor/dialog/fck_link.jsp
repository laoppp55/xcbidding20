...
<head>
    ...
    <script type="text/javascript">
        function AddLink()
        {
            ...
            var winStr = "/webbuilder/template/addlink.jsp?column=<%=columnID%>";
            returnvalue = window.showModalDialog(winStr,"CreateLink","font-family:Verdana;font-size:12;dialogWidth:780px; dialogHeight:520px;status:yes;scrollbars=yes");

            if((returnvalue != null)&&(returnvalue != ""))
                document.all.txtUrl.value = returnvalue;
...
<div id="divInfo" style="DISPLAY: none">
    ...
    <div id="divLinkTypeUrl">
            ...
            <tr>
                <td nowrap="nowrap">
                    ...
                    <select id="cmbLinkProtocol">
                        <option value=""   fckLang="DlgLnkProtoOther" selected="selected">&lt;other&gt;</option>
        ...
        <div id="divBrowseServer">
            <input type="button" value="Add Link" fckLang="DlgBtnAddLink" onclick="AddLink();" />
        </div>
    </div>
