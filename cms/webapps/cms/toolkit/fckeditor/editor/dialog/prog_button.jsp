...
function Ok()
{
    ...
    SetAttribute( oActiveEl, 'src', GetE('imgsrc').value ) ;
		...
		<tr>
			<td align="center">
				<table border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr><td><span >ImgSrc<input type="text" id="imgsrc" style="width: 100%"/></span> </td></tr>
                    <tr>
						<td>
							...
							<select id="txtType">
                                ...
                                <option fcklang="DlgButtonTypeImg" value="image">Img</option>
                            </select>
						</td>
					</tr>
