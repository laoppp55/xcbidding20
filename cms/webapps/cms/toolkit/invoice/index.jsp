...
<%
    ...
    list = orderMgr.getInvoiceContentList(siteid);
%>
<html>
<head>
<title>发票内容管理</title>
            ...
            <td>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="css_002">
                <tr  bgcolor="#FFFFFF" class="css_001">
                    <td align="center" width="40%">发票内容</td>
                  ...
                  %>
                <tr  bgcolor="#FFFFFF" class="css_001">
                    <td align="center"><%=invoice.getContentinfo() == null?"":StringUtil.gb2iso4View(invoice.getContentinfo())%></td>
                    <td align="center"><%=invoice.getCreatedate().toString().substring(0,10)%></td>
                    <td align="center"><a href="javascript:edit(<%=invoice.getId()%>)">修改</a></td>
                    <td align="center"><a href="javascript:del(<%=invoice.getId()%>)">删除</a></td>
                </tr>
                  <%}%>
               </table>
            </td>
