        ...
        <tr>
            <td height="360" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <form method="POST" action="addproject.jsp" name="addSurveyForm" onsubmit="javascript:return checkSurvey();">
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="150" class="black12c">添加新项目</td>
                                        <td width="697"></td>
                                    </tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;<input type="text" name="projname" size="80">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="1" bgcolor="#898898"></td>
                                        <td>
                                            &nbsp;&nbsp;<input type="text" name="projcode" size="80">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="1" bgcolor="#898898"></td>
