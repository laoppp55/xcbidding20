...
var MTMLinkedJSURL, MTMLinkedSS = true, MTMSSHREF = "../css/global.css", MTMLinkedInitFunction, MTMDOCTYPE, MTMcontentType, MTMHeader, MTMFooter, MTMrightClickMessage, MTMDefaultTarget = "cmsright", MTMTimeOut = 1;
...
var MTMenuText = "<font class=line>企业分类信息</font>", MTMRootIcon = "menu_new_root.gif", MTMRootColor = "#000000";
...
function MTMSubAction(SubItem) {
    ...
    if (SubItem.expanded) {
        ...
        if (parentNum == 1) {                              //点击第一层的下面层，清空保存信息的隐含域，从新设置信息
            ...
            //alert(document.getElementById("expnameid").value);
        } else {
            document.getElementById("expnameid").value = document.getElementById("expnameid").value + SubItem.number+ ":";
            //alert(document.getElementById("expnameid").value);
        }*/
