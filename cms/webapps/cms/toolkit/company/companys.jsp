...
<%
    ...
    String sqlcount = "select count(id) from tbl_companyinfo where siteid =" + siteid;
    int totalNum = 0;
    int totalPage = 0;
    ...
    if (startflag != 1) {
        ...
        String sqlsearch = "select * from tbl_companyinfo where siteid =" + siteid + " and companyname like '@" + searchname + "@' order by id desc";
        String sqlsearchcount = "select count(id) from tbl_companyinfo where siteid =" + siteid + " and companyname like '@" + searchname + "@'";
...
<table cellSpacing=0 borderColorDark=#ffffec cellPadding=0 width="100%"
    ...
    <tr>
         <td align="center" width="20%"><a href="indextest.jsp?siteid=<%=siteid%>">测试页面</a></td>
         <td align="center" width="20%"><a href="addCompanyColumn.jsp?siteid=<%=siteid%>">添加分类</a></td>
        <td align="center" width="50%"><a href="addCompany.jsp?siteid=<%=siteid%>">添加企业信息</a></td>
