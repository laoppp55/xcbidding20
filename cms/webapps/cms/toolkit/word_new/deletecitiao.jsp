...
<%
    ...
    if(docreate) {
         wordMgr.deleteCitiao(siteid,id);
        out.write("<script language=\"javascript\">alert(\"信息删除成功！\");window.opener.location='citiaos.jsp';window.close();</script>");
    }
%>
<html>
<head>
...
<table width="100%" border="1" cellpadding="3" cellspacing="1" class="css_002">
    <form name="columnForm" method="post" action="deletecitiao.jsp">
