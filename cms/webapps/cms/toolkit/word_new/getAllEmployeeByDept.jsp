...
<%
    ...
    List users = userMgr.getEmployeesBYDepartmentID(deptid,siteid);

    String users_str = "";
    for (int i=0; i<users.size(); i++) {
        User user = new User();
        user = (User)users.get(i);
        if (!userid.equalsIgnoreCase(user.getUserID())) users_str = users_str + user.getNickName() + ":" + user.getUserID()+ ";";
    }
