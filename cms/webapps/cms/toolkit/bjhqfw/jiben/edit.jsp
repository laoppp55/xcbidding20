      ...
      <td align="center">
        <table width="70%" border="0" cellpadding="0">
          <tr bgcolor="#F4F4F4" align="center">
            <td height="30" valign="middle" bgcolor="#F4F4F4" class="css_003">修改会议室信息</td>
          </tr>
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="css_002">
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">会议室名称：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="meetname" value="<%=jb.getMeetname()==null?"":jb.getMeetname()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">会议室容量：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="meetmax" value="<%=jb.getMeetmax()==null?"":jb.getMeetmax()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">会议室位置：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="meetroot" value="<%=jb.getMeetroot()==null?"":jb.getMeetroot()%>"></td>
                </tr>
               </table>
            </td>
          </tr>
