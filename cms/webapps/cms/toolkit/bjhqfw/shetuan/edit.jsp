...
<%
    ...
    if(startflag == 1){
        ...
        st.setPasswd(passwd);
        sMgr.updateSheTuan(st,id);
        response.sendRedirect("index.jsp");
    }
    st = sMgr.getByIdSheTuan(id);
      ...
      <td align="center">
        <table width="70%" border="0" cellpadding="0">
          <tr bgcolor="#F4F4F4" align="center">
            <td height="30" valign="middle" bgcolor="#F4F4F4" class="css_003">修改社团用户</td>
          </tr>
          <tr bgcolor="#d4d4d4" align="center">
            <td>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="css_002">
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">社团名称：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="stname" value="<%=st.getStname()==null?"":st.getStname()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">联系人：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="lianxiren" value="<%=st.getLianxiren()==null?"":st.getLianxiren()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">电话：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="phone" value="<%=st.getPhone()==null?"":st.getPhone()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">邮件：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="email" value="<%=st.getEmail()==null?"":st.getEmail()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">用户名：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="text" name="username" value="<%=st.getUsername()==null?"":st.getUsername()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">用户口令：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="password" name="passwd" value="<%=st.getPasswd()==null?"":st.getPasswd()%>"></td>
                </tr>
                <tr  bgcolor="#FFFFFF" class="css_001">
                  <td width="50%" align="right">确认用户口令：&nbsp;</td>
                    <td align="left" width="50%">&nbsp;<input type="password" name="passwd1" value="<%=st.getPasswd()==null?"":st.getPasswd()%>"></td>
                </tr>
               </table>
            </td>
          </tr>
