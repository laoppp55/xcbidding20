  ...
  <td height="50" bgcolor="#F6F5F0">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td></td>
        <td width="50" class="black12" align=center><a href="viewuserinfo.jsp?sid=<%=sid%>" target="_blank">用户信息</a></td>
        <td></td>
        <td width="50" class="black12" align=center><a href="#" onclick="javascript:window.location='viewSurvey.jsp?sid=<%=sid%>';">返回</a></td>
        <td></td>
