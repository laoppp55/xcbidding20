...
<head>
  ...
  <script type="text/javascript">
    function DeleteAnswer(qid, sid, aid)
    {
      ...
      if (str)
        window.location = "deletePAnswer.jsp?qid=" + qid + "&sid=" + sid + "&aid=" + aid;
    }

    function checkSelect(){
      if((addQuestionForm.qanswer.value == null)||(addQuestionForm.qanswer.value == "")){
        alert("请选择要上传的图片");
        return false;
      }
      return true;
...
<form name=addQuestionForm enctype="multipart/form-data" method="post" action="upPAnswer.jsp" onsubmit="javascript:return checkSelect();">
  ...
  <td valign="top">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td bgcolor="#898898"></td>
        <td align="left" class="black12">&nbsp;&nbsp;<%=StringUtil.iso2gb(qname)%>
        </td>
      </tr>
      <tr>
        <td height="1" bgcolor="#898898"></td>
      ...
      <tr>
        ...
        <td align="left" valign="middle">
          &nbsp;<input type="file" name="qanswer" size=80>
        </td>
      </tr>
    </table>
  </td>
  ...
  <td height="80" align="center" valign="middle">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="60"></td>
        <td width="95"><input type="button" value="返回管理首页" name="survey_back" onclick="window.location='index.jsp';">
        </td>
        <td width="310"></td>
      </tr>
    </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="600" height="80" align="center" class="black12">
            <a href="http://<%=authToken.getSitename().replaceAll("_",".")%>/answerspic/<%=picurl%>" target=_blank><img src="http://<%=authToken.getSitename().replaceAll("_",".")%>:8088/answerspic/<%=picurl%>" alt=""
                                                                   width=60
                                                                   height=60 border=0></a></td>
          <td width="1" bgcolor="#898898"></td>
          <td width="297" align="center" class="black12"><a href="javascript:DeleteAnswer(<%=qid%>,<%=sid%>,<%=aid%>)">删除</a>
          </td>
        </tr>
        <tr>
          <td width="1" bgcolor="#898898"></td>
