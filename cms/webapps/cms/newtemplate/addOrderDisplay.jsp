...
<%
    ...
    if (doCreate) {
        ...
        String content = "[TAG][HTMLCODE][MARKTYPE]" + type +"[/MARKTYPE][STYLES]"+head+"[/STYLES][CONTENT]" +
                ...
                "{\r\n" +
                "var reg = new RegExp(\"(^|&|\\\\?)\"+ name +\"=(&lsquare;^&&rsquare;*)(&|$)\"), r;\r\n" +
                "if (r=this.match(reg)) return unescape(r&lsquare;2&rsquare;);\r\n" +
                "return null;\r\n" +
                "}\r\n" +
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doit()
        {
            var isMSIE = (navigator.appName == "Microsoft Internet Explorer");
            if (isMSIE) {
                markform.action = "addOrderDisplay.jsp";
