...
<table width="100%" border="1">
    ...
    <tr height=30>
        <td>列表类型：
            ...
            <input type="button" style="height:20;width:30;font-size:9pt" onclick="createStyle(3,<%=columnID%>);" value="新建">
            <input type="button" style="height:20;width:30;font-size:9pt"
                    onclick="updateStyle(3,listType.options[listType.selectedIndex].value,<%=columnID%>);" value="修改">
            <input type="button" style="height:20;width:30;font-size:9pt"
                    onclick="previewStyle(3,listType.options[listType.selectedIndex].value);" value="预览">
        </td>
    </tr>
    <tr height=30>
        <td>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td valign=top>
                        <table width="100%">
                            <tr>
                                <td>中文名称：<input name="chineseName" value="<%=cname%>" class=tine></td>
                            </tr>
                            <tr>
                                <td>标记描述：<br><textarea rows=5 cols=30 name="notes" class=tine><%=notes%>
                                </textarea></td>
                            </tr>
                        </table>
                    </td>
