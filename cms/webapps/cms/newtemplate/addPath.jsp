...
<table width="96%" border="0" align=center>
    ...
    <tr height="30">
        <td>
            ...
            <input type="button" value="新建" style="height:20;width:30;font-size:9pt" onclick="createStyle(8,0);">
            <input type="button" style="height:20;width:30;font-size:9pt"
                    onclick="updateStyle(8,listType.options[listType.selectedIndex].value,0);" value="修改">
            <input type="button" style="height:20;width:30;font-size:9pt"
                    onclick="previewStyle(8,listType.options[listType.selectedIndex].value);" value="预览">
        </td>
    </tr>
    <tr height="50">
        <td align=center>
