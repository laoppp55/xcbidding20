...
<%
    ...
    String filePath = appRoot + "sites" +  File.separator + "images";
...
<table border=1 borderColorDark=#ffffec borderColorLight=#5e5e00 cellPadding=0 cellSpacing=0 width='100%'>
    ...
    <%
        for (int i = 0; i < fList.size(); i++) {
            ...
            //System.out.println("<td width='70%'><img src=\"http://www.coosite.com" + "/sites/images/" +filename + "\" /></td>");
            ...
            out.println("<td width='70%'><img src=\"/_sys_images/" +filename + "\" /></td>");
            out.println("</tr>");
        }
    %>
</table>
