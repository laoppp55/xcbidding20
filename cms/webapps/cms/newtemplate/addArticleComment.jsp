...
"<td align=\"right\">&nbsp;&nbsp;&nbsp;&nbsp;</td>\n" +
"</tr>\n" +
"</table><table "+style+"   class=\"biz_table\">"+
"    <form name='form' action='/" + StringUtil.replace(sitename,".","_") + "/_prog/comment.jsp' onsubmit='return check();'>" +
                "<input type='hidden' name='siteid' value='" + siteID + "'>" +
                "<input type='hidden' name='articleid' value='&lt;%=articleid%&gt;'>" +
                "<input type='hidden' name='startflag' value='1'>" +
                "<tr><td valign='top'> &#22995;&#21517;&#65306;</td><td valign='top'><input type='text' name='name' value=''></td></tr>" +
                "<tr><td valign='top'>&#32852;&#31995;&#26041;&#24335;&#65306;</td><td valign='top'><input type='text' name='link' value=''></td></tr>" +
                "<tr><td valign='top'>&#20869;&#23481;&#65306;</td><td valign='top'><textarea rows='10' cols='50' name='content'></textarea></td></tr>" +
                "<tr><td valign='top' colspan='2'><input type='submit' name='sub' value='&#25552;&#20132;'></td></tr></form></table>" +
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doit()
        {
            var isMSIE = (navigator.appName == "Microsoft Internet Explorer");
            if (isMSIE) {
                markform.action = "addArticleComment.jsp";
    ...
    <form name="markform">
        ...
        <tr height=24>
            <td>字体&nbsp;&nbsp;&nbsp;
                ...
                px
                文字颜色&nbsp;
                <div id="colorpanel" style="position:absolute;display:none;width:253px;height:177px;"></div><input type="text" <%if(viewtd2!=null){%>value="<%=viewtd2%>"<%}%> size="8" alt="color1" name="ziticol"   onclick="OnDocumentClick();"><script language="javascript">
                intocolor();
            </script></td>
        </tr>
        <tr><td>文本框大小&nbsp;&nbsp;
