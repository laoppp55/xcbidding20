...
"<input type=hidden name=markid id=\"markid\" value=\"-1\">");
        ...
        //if (modelcontent.indexOf("[TAG][ARTICLE_MAINTITLE][/ARTICLE_MAINTITLE][/TAG]") != -1) {
            out.write("标题(<a href=\"javascript:upload_attrpic_onclick('mt');\">图</a>)<input class=tine name=maintitle id=\"maintitle\"\n" +
...
"        title=\"双击鼠标左键即可选择历史图片\"><br>");
        ...
        if (modelcontent.indexOf("[TAG][ARTICLE_AUTHOR][/ARTICLE_AUTHOR][/TAG]") != -1) {
            out.write("文章作者(<a href=\"javascript:upload_attrpic_onclick('au')\">图</a>)<input class=tine name=author id=\"author\"\n" +
"                                                                        size=10 onDblClick=\"history('au');\"\n" +
"        title=\"双击鼠标左键即可选择历史图片\"><br>");
        }
        if (modelcontent.indexOf("[TAG][ARTICLE_SOURCE][/ARTICLE_SOURCE][/TAG]") != -1) {
            out.write("文章来源(<a href=\"javascript:upload_attrpic_onclick('sr')\">图</a>)<input class=tine name=source id=\"source\"\n" +
"                                                                        size=10 onDblClick=\"history('sr');\"\n" +
"        title=\"双击鼠标左键即可选择历史图片\"><br>");
        }
        if (modelcontent.indexOf("[TAG][ARTICLE_KEYWORD][/ARTICLE_KEYWORD][/TAG]") != -1) {
            out.write("文章关键字<input class=tine name=keyword size=30><br>");
        }
...
"        title=\"双击鼠标左键即可选择历史图片\">&nbsp;&nbsp;<br>");
      //  }
        if (modelcontent.indexOf("[TAG][ARTICLE_SUMMARY][/ARTICLE_SUMMARY][/TAG]") != -1) {
            out.write("文章概述<textarea cols=\"60\" rows=\"2\" id=\"summaryID\" name=\"summary\"></textarea><br>");
        }
        if (modelcontent.indexOf("[TAG][PRODUCT_BIGPIC]商品大图片[/PRODUCT_BIGPIC][/TAG]") != -1) {
            out.write("大图片(<a href=\"javascript:upload_attrpic_onclick('bigpic')\">图</a>)：<input class=tine name=bigpic id=\"bigpic\"\n" +
...
"        ></textarea>&nbsp;&nbsp;<br>");
       ...
       out.write("<br><input class=tine type=button value=\"  保存  \" onclick=\"create(createForm);\">&nbsp;&nbsp;\n" +
