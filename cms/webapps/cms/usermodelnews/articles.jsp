...
{
    window.open("createarticle.jsp?columnid=" + columnID, "", "width=935,height=650,left=5,top=5,status,scrollbars");
}
...
{
    window.open("editarticle.jsp?articleid=" + articleID + "&columnid="+columnID+"&range=" + range + "&start=" + start + "&fromflag=" + from, "", "width=935,height=650,left=5,top=5,status,scrollbars");
}
