...
<frameset cols=160,* border=0 frameborder=0 framespacing=0>
  <frameset frameborder=0 framespacing=0 border=0 cols=* rows=0,*>
    <frame src=topStories_21.jsp name=cmsleft scrolling=auto marginheight=0 marginwidth=0 noresize>
    <frame marginwidth=5 marginheight=5 src=menu.html name=menu noresize scrolling=auto frameborder=0>
  </frameset>
  <frameset rows="50%,*">
    <frame src="topStories_22.jsp?column=<%=columnID%>" name="cmsright">
    <frame src="topStories_23.jsp?column=<%=columnID%>&mark=<%=markID%>" name=main2 scrolling=auto marginheight=0 marginwidth=5 noresize>
  </frameset>
</frameset>
</html>
