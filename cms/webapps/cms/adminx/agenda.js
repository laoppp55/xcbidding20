...
function popup(url,framename) {	// load an url in the window/frame designated by "framename".
	var w=parent.open(url,framename,"top=200,left=200,width=400,height=200,scrollbars=1,resizable=1");
	if (w&&url.split(":")[0]=="mailto") w.close();
	else if (w&&!framename) w.focus();
}

function getDateByDOW(y,m,q,n) { // return the d(ate) of the q-th n-day of a specific m(onth) in a specific y(ear)
