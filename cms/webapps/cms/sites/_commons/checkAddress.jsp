...
<%
    ...
    if (ug == null) {
        ...
        response.sendRedirect("/www_bucghb_com/_prog/login.jsp");
        //out.print("<script language=javascript>alert(\"您还没有登录！请先登录！\");window.location.href='/www_bucghb_com/_prog/login.jsp';</script>");
        return;*/
        out.write("nologin");
    } else {
        int userid = ug.getId();
