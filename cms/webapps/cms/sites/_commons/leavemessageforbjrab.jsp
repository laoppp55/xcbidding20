...
<head>
    ...
    <script language='javascript'>
        function getinfo(id)
        {
            window.open("getinfo.jsp?id=" + id, "", 'width=600,height=380,left=200,top=200');
        }
                                                ...
                                                <table width="690" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="middle" style="line-height:18px;">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;本栏目受理单位及个人对市无线电管理局职责范围内的有关法规、政策、程序等问题的咨询。一般问题将在15个工作日内给予答复，复杂些的适当延长。本栏目答复是一种指导性意见，不具有法定效力。具体问题应通过法定途径（诉讼、复议、仲裁、信访等）解决
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table width="690" border="0" cellspacing="0" cellpadding="0">
                                                    <form name="searchform" method="post" action="/_commons/searchmessageforbjrab.jsp" target="_blank"  onsubmit="return check_keyword();">
                                                        <tr>
                                                            <td>
                                                                关键字：<input type="text" name="keyword" value="" size="10" maxlength="50">
                                                                开始时间：<input type="text" name="sdate" value="" size="10" maxlength="20" onclick="javascript:setday(this);">
                                                                结束时间：<input type="text" name="edate" value="" size="10" maxlength="20"  onclick="javascript:setday(this);">
                                                                <input type="submit" name="ok" value="查询">
                                                            </td>
                                                            <td height="50" align="right"><a href="/zmhd/zxzx/"><img
