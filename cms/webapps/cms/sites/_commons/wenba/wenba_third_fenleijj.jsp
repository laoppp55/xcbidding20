...
%>
	<% //已解决问提分页
		...
		int intPageSize_jiejue=10; //每页显示的记录数
	    ...
	    List pagelist_jiejue = iwenba.getConPage(1,classid);
...
function sousuo_fenlei(){
	...
	var url ="wenba_leibiao1.jsp?pro=<%= Pro%>&cid=" +fenleiID +"&keys=" + keys;
	if(fenleiID==""){
		alert("请选择分类");
		return ;
	}
...
<table width="982" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" background="/images/wenba_r4_c3.jpg"><img src="/images/wenba_r6_c5.jpg" width="4" height="7" align="absmiddle" />&nbsp;<a href="/wenba/wenba_difang.jsp?cid=<%= classid%>&pro=北京" class="bai">地方问答</a></td>
    ...
    <td width="1" align="center" background="/images/wenba_r4_c3.jpg"><img src="/images/wenba_r5_c5.jpg" width="1" height="12" align="absmiddle" /></td>
    <td align="center" background="/images/wenba_r4_c3.jpg"><a href="/wenba/wenba_zhuanjia.jsp?cid=<%= classid%>" class="bai">专家介绍</a></td>
                                ...
                                <tr>
                                  ...
                                  <td><table width="95%" border="0" align="right" cellpadding="0" cellspacing="0">
                                      <%
					                    ...
					                    String str;
					                    if(titles.length()>10) {
					                    	str = titles.trim().substring(0,10) + "...";
					                    }else{
					                    	str = titles;
					                    }           
									   %>
          ...
          <td valign="top" background="/images/wenba_wentifenlei_r4_c234.jpg"><table width="1" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
              <td valign="top"><table width="1" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="250"><table width="198" border="0" align="center" cellpadding="0" cellspacing="0">
                      <%
                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
                        <td height="20">
                        	<img src="/images/wen_ba_r30_c6.jpg" width="3" height="3" align="absmiddle" />&nbsp;&nbsp;<a href="/wenba/wenba_finsh.jsp?id=<%= wtxt.getId()%>&fenlei=<%= tuijian%>"><%= wtxt.getTitles()%></a>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="248" align="center" background="/images/wenba_woyaoda_r7_c5.jpg" class="blackc12c"><a href="#" onclick="wenti_jiejue_change()">已解决的问题</a></td>
                      <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                    ...
                    <tr>
                      <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <%
							...
							String color = "";
                    		List wenti_jiejue = iwenba.getQuestions(end_no_jiejue, begin_no_jiejue, 1,classid);
                    		wenti wtj = null;
                    		String date_str_jiejue = null;
                    		for (int i = 0; i < wenti_jiejue.size(); i++) {
                    			if(i%2==0){
									color = color2;
								}else{
									color = color1;
								}
                    			wtj = (wenti) wenti_jiejue.get(i);
                    			date_str_jiejue = wtj.getCreatedate().toString();
                    			int posi = date_str_jiejue.indexOf(" ");
                    			date_str_jiejue = date_str_jiejue.substring(0, posi);
                    			String titles = wtj.getTitles().trim();  
			                    String str;
			                    if(titles.length()>18) {
                    	...
                    	%>
                        <tr>
                          <td height="25" align="left" bgcolor="<%= color%>">&nbsp;&nbsp;[<%= wtj.getCname()%>]</td>
                          <td align="left" bgcolor="<%= color%>">&nbsp;&nbsp;
                        	...
                        	<a href="javascript:xiazaiw()">下载</a>
                        	<%} %>
                          </td>
                          <script type="text/JavaScript">
	                      	function xiazaiw(){
                          ...
                          <td align="center" bgcolor="<%= color%>"><%= wtj.getProvince()%></td>
                          <td align="center" bgcolor="<%= color%>"><%= wtj.getXuanshang()%>分</td>
                          <td align="center" bgcolor="<%= color%>"><%= wtj.getAnwsernum()%></td>
                          <td align="center" bgcolor="<%= color%>">[<%= date_str_jiejue%>]</td>
                        </tr>
                        <%} %>
						<tr>
                    ...
                    <tr>
                      <td height="25" align="right" valign="bottom">
					  		<%if(intPageCount_jiejue>1){ %>
					  			<%if (intPage_jiejue > 1) {%>
	                    		<a href="wenba_third_fenleijj.jsp?page_jiejue=<%=intPage_jiejue - 1%>&cid=<%=classid%>"><img src="/images/wenba_woyaoda_r9_c12.jpg" width="4" height="7" border="0" align="absmiddle" /></a>
	                    		<%}%>&nbsp;
	                    		<!-- 共<%= intPageCount_jiejue%>页 -->
	                    		<a href="wenba_third_fenleijj.jsp?page_jiejue=1&cid=<%=classid%>">首页</a>
	                    		<%if (intPage_jiejue > 1) {%>
	                    		<a href="wenba_third_fenleijj.jsp?page_jiejue=<%=intPage_jiejue - 1%>&cid=<%=classid%>">上一页</a><%}%>
	                    		<%if (intPage_jiejue < intPageCount_jiejue) {%>
	                    		<a href="wenba_third_fenleijj.jsp?page_jiejue=<%=intPage_jiejue + 1%>&cid=<%=classid%>">下一页</a><%}%>
	                            <a href="wenba_third_fenleijj.jsp?page_jiejue=<%=intPageCount_jiejue%>&cid=<%=classid%>">尾页</a>	 &nbsp;
								<%if (intPage_jiejue < intPageCount_jiejue) {%>
	                    		<a href="wenba_third_fenleijj.jsp?page_jiejue=<%=intPage_jiejue + 1%>&cid=<%=classid%>"><img src="/images/wenba_woyaoda_r9_c14.jpg" width="4" height="7" border="0" align="absmiddle" /></a>
	                    		<%}%>&nbsp;&nbsp;
	                    	<%} %>	
	                    </td>
                    </tr>
