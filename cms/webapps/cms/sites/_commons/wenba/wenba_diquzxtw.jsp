...
<%
	...
	String thispage = (String)session.getAttribute("difangtiwenthispage")==null?"0":(String)session.getAttribute("difangtiwenthispage");
	String allpages = (String)session.getAttribute("difangtiwenallpages")==null?"0":(String)session.getAttribute("difangtiwenallpages");
	String perpagenum = session.getAttribute("difangtiwenpagenum")==null?"0":(String)session.getAttribute("difangtiwenpagenum");
	List pagelist = (List)session.getAttribute("difangtiwenpagelist");
	if(pagelist==null){
		response.sendRedirect("dodifangZXTW.jsp");
	}
	String str3 = (String)session.getAttribute("str3");
	session.setAttribute("str3",null);
	session.setAttribute("difangtiwenthispage",null);
	session.setAttribute("difangtiwenallpages",null);
	session.setAttribute("difangtiwenpagenum",null);
	session.setAttribute("difangtiwenpagelist",null);
	String provincename = "";
	String columnid = "0";
	String keyword = "";
	if(str3!=null){
...
function gonum(){
    	...
    	if(gopagenum==""){
    		...
    		document.form1.action = "dodifangZXTW.jsp?proname=<%=provincename %>&cid=<%=columnid %>&keys=<%=keyword %>";
...
function sousuo_fenlei(){
	...
	var url ="dodifangZXTW.jsp?proname=<%= provincename%>&cid=" +fenleiID +"&keys=" + keys;
	if(fenleiID==""){
		alert("请选择分类");
		return ;
	}
  ...
  <tr>
    <td valign="top"><%@ include file="/include/wenbaZJL.jsp"%>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="25" class="black14">&nbsp;地方问答 --<%=provincename %></td>
        </tr>
        <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="35" background="/images/wenba_woyaoda_r2_c2.jpg">&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <tr>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="248" height="30" align="center" background="/images/wenba_woyaoda_r7_c5.jpg" class="blackc12c"><a href="dodifangZXTW.jsp?proname=<%=provincename %>" >最新提出问题</a></td>
                            <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                            <td width="248" align="center" background="/images/wenba_woyaoda_r7_c10.jpg" class="blackc12c"><a href="dodifangYJJ.jsp?proname=<%=provincename %>">已解决的问题</a></td>
                            <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                    ...
                    <tr>
                      <td valign="top" background="/images/wenba_woyaoda_r8_c5.jpg"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="401" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td align="left" bgcolor="<%= color%>">
                                  	<a href="/wenba/wenba_finsh.jsp?cid=<%=wq.getColumnid()%>&id=<%=wq.getId()%>&fenlei=<%= lanmu%> ">&nbsp;&nbsp;<%= wq.getTitle()%></a>&nbsp;&nbsp;
                                  </td>         
                          ...
                          <tr>
        				<td width="1036" align="center" valign="top" class="font">
        				<%
							if (Integer.parseInt(thispage) >1){
						%>
                		<a href="dodifangZXTW.jsp?thispage=1&proname=<%=provincename %>&cid=<%=columnid %>&keys=<%=keyword %>">首页</a>&nbsp;&nbsp;&nbsp;<a href="dodifangZXTW.jsp?thispage=<%=Integer.parseInt(thispage)-1 %>&proname=<%=provincename %>&cid=<%=columnid %>&keys=<%=keyword %>">上一页</a>
                		<%
							}
							if (Integer.parseInt(allpages) > Integer.parseInt(thispage)){
							%>
              				&nbsp;&nbsp;<a href="dodifangZXTW.jsp?thispage=<%=Integer.parseInt(thispage)+1 %>&proname=<%=provincename %>&cid=<%=columnid %>&keys=<%=keyword %>">下一页</a>&nbsp;&nbsp; &nbsp;<a href="dodifangZXTW.jsp?thispage=<%=Integer.parseInt(allpages)%>&proname=<%=provincename %>&cid=<%=columnid %>&keys=<%=keyword %>">末页</a>
              				<%
							}
							%>
