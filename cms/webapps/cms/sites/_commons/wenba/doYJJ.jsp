...
list = iwenba.getYJJ(Integer.parseInt(fenlei),province,keyword);
...
session.setAttribute("yijjpagenum",String.valueOf(perpagenum));
session.setAttribute("yijjpagelist",pagelist);
session.setAttribute("yijjallpages",String.valueOf(allpages));
session.setAttribute("yijjthispage",String.valueOf(thispage));
session.setAttribute("yjjcid",fenlei);
response.sendRedirect("wenba_YJJ.jsp");
%>