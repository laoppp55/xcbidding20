...
list = iwenba.getZXTW(Integer.parseInt(fenlei),province,keyword);
...
session.setAttribute("tiwenpagenum",String.valueOf(perpagenum));
session.setAttribute("tiwenpagelist",pagelist);
session.setAttribute("tiwenallpages",String.valueOf(allpages));
session.setAttribute("tiwenthispage",String.valueOf(thispage));
session.setAttribute("zxtwcid",fenlei);
response.sendRedirect("wenba_ZXTW.jsp");
%>