        		...
        		<table>
        			<%if(zhuanjialist.size()>0){ 
        				for(int i=0;i<zhuanjialist.size();i++){
							...
							System.out.println("touxian:"+touxian);
        			%>
        			<tr>
        				<td>
        					<img src="/images/zhuanjiajieyi_r2_c2.jpg" width="66" height="88" hspace="2" vspace="2" border="0" />
        				</td>
        				<td>
        					<table>
        						<tr><td>专家姓名：<%=u.getUsername() %></td></tr>
        						<tr><td>头衔：<%=touxian %></td></tr>
        						<tr><td>积分：<%=u.getUsergrade() %></td></tr>
        						<tr><td><a href="/wenba/aaaaa.jsp?userid=<%= u.getUserid()%>&cid=<%= CID%>" class="hei">【查看详情】</a></td></tr>
        						<tr><td><a href="">专家提问</a></td></tr>
        					</table>
        				</td>
        			</tr>
