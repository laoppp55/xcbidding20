...
<%
	...
	String cid = session.getAttribute("zxtwcid")==null?"0":(String)session.getAttribute("zxtwcid");
	session.setAttribute("zxtwcid",null);
	int classid = Integer.parseInt(cid);
	//System.out.println("-------------------------------------------classid:"+classid);
	
	String thispage = (String)session.getAttribute("tiwenthispage")==null?"0":(String)session.getAttribute("tiwenthispage");
	String allpages = (String)session.getAttribute("tiwenallpages")==null?"0":(String)session.getAttribute("tiwenallpages");
	String perpagenum = session.getAttribute("tiwenpagenum")==null?"0":(String)session.getAttribute("tiwenpagenum");
	List pagelist = (List)session.getAttribute("tiwenpagelist");
	if(pagelist==null){
		response.sendRedirect("doZXTW.jsp");
	}
...
function gonum(){
    	...
    	if(gopagenum==""){
    		...
    		document.form1.action = "doZXTW.jsp?province=<%=provincename %>&fenlei=<%=columnid %>&keyword=<%=keyword %>";
...
function sousuo(){
	...
	document.form1.action = "doZXTW.jsp?fenlei="+fenlei+"&province="+province+"&keyword="+keyword;
    document.form1.submit();
}
</script>
<body>
...
<table width="982" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><%@ include file="/include/wenbaZJL.jsp"%>
      ...
      <table width="1" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><img src="/images/bai.gif" width="1" height="7" /></td>
        </tr>
      </table>
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="248" height="30" align="center" background="/images/wenba_woyaoda_r7_c5.jpg" class="blackc12c"><a href="doYJJ.jsp">最新提出问题</a></td>
                      <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                      <td width="248" align="center" background="/images/wenba_woyaoda_r7_c7.jpg" class="blackc12c"><a href="doYJJ.jsp">已解决的问题</a></td>
                      <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                      <td width="247" align="center" background="/images/wenba_woyaoda_r7_c10.jpg" class="blackc12c"><a href="doLHD.jsp">零回答的问题</a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="550" valign="top" background="/images/wenba_woyaoda_r8_c5.jpg"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                    ...
                    <tr>
						...
						%>
                		<a href="doZXTW.jsp?thispage=1&province=<%=provincename %>&fenlei=<%=columnid %>&keyword=<%=keyword %>">首页</a>&nbsp;&nbsp;&nbsp;<a href="doZXTW.jsp?thispage=<%=Integer.parseInt(thispage)-1 %>&province=<%=provincename %>&fenlei=<%=columnid %>&keyword=<%=keyword %>">上一页</a>
                		<%
							}
							if (Integer.parseInt(allpages) > Integer.parseInt(thispage)){
							%>
              				&nbsp;&nbsp;<a href="doZXTW.jsp?thispage=<%=Integer.parseInt(thispage)+1 %>&province=<%=provincename %>&fenlei=<%=columnid %>&keyword=<%=keyword %>">下一页</a>&nbsp;&nbsp; &nbsp;<a href="doZXTW.jsp?thispage=<%=Integer.parseInt(allpages)%>&province=<%=provincename %>&fenlei=<%=columnid %>&keyword=<%=keyword %>">末页</a>
              				<%
							}
							%>
