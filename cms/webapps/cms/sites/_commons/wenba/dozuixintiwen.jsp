...
list = iwenba.getZuiXinTiWen(Integer.parseInt(fenlei),province,keyword);
...
session.setAttribute("ZXTWpagenum",String.valueOf(perpagenum));
session.setAttribute("ZXTWpagelist",pagelist);
session.setAttribute("ZXTWallpages",String.valueOf(allpages));
session.setAttribute("ZXTWthispage",String.valueOf(thispage));
session.setAttribute("zjzxtwcid",fenlei);
response.sendRedirect("wenba_ZJZXTW.jsp");
%>