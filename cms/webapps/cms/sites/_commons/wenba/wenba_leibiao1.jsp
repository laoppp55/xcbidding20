...
<% //最新提出问提分页
	    ...
	    List pagelist = iwenba.getSousuoQuestionsPidnum(classid,1,skey,Pro);
...
function sousuo_fenlei(){
	...
	var url ="wenba_leibiao1.jsp?cid=" +fenleiID +"&keys=" + keys;
	if(fenleiID==""){
		alert("请选择分类");
		return ;
	}
...
<table width="982" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="1" align="center" background="/images/wenba_r4_c3.jpg"><img src="/images/wenba_r5_c5.jpg" width="1" height="12" align="absmiddle" /></td>
    <td align="center" background="/images/wenba_r4_c3.jpg"><img src="/images/wenba_r6_c5.jpg" width="4" height="7" align="absmiddle" />&nbsp;<a href="/wenba/wenba_leibiao1.jsp?cid=<%= classid%>&keys="" " class="bai">最新解决问题</a></td>
    <td width="1" align="center" background="/images/wenba_r4_c3.jpg"><img src="/images/wenba_r5_c5.jpg" width="1" height="12" align="absmiddle" /></td>
                ...
                <tr>
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="248" align="center" background="/images/wenba_woyaoda_r7_c5.jpg" class="blackc12c"><a href="#">已解决的问题</a></td>
                      <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                  ...
                  <td valign="top" background="/images/wenba_woyaoda_r8_c5.jpg"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                        ...
                        <%
							...
							String color = "";
                        	List list = iwenba.getSousuoQuestionsPid(end_no,begin_no,classid,1,skey,Pro);
                    ...
                    <tr>
                      <td height="40" align="right" valign="bottom">
                      	<%if(intPageCount>1){ %>
                      		<%if (intPage > 1) {%>
                      		<a href="wenba_leibiao1.jsp?page=<%=intPage - 1%>&cid=<%=classid%>&keys=<%= skey%>"><img src="/images/wenba_woyaoda_r9_c12.jpg" width="4" height="7" border="0" align="absmiddle" /></a>&nbsp;
                            <%} %>
                            <!-- 共<%= intPageCount%>页 --> 
	                    	<a href="wenba_leibiao1.jsp?page=1&cid=<%=classid%>&keys=<%= skey%>">首页</a>
	                    	<%if (intPage > 1) {%>
	                    	<a href="wenba_leibiao1.jsp?page=<%=intPage - 1%>&cid=<%=classid%>&keys=<%= skey%>">上一页</a><%}%>
	                    	<%if (intPage < intPageCount) {%>
	                    	<a href="wenba_leibiao1.jsp?page=<%=intPage + 1%>&cid=<%=classid%>&keys=<%= skey%>">下一页</a><%}%>
	                        <a href="wenba_leibiao1.jsp?page=<%=intPageCount%>&cid=<%=classid%>&keys=<%= skey%>">尾页</a>&nbsp;
	                        <%if (intPage < intPageCount) {%>
	                    	<a href="wenba_leibiao1.jsp?page=<%=intPage + 1%>&cid=<%=classid%>&keys=<%= skey%>"><img src="/images/wenba_woyaoda_r9_c14.jpg" width="4" height="7" border="0" align="absmiddle" /></a>
	                    	<%} %>&nbsp;&nbsp;&nbsp;&nbsp;
	                    <%} %>
	                  </td>
                    </tr>
