                ...
                <td height="195" align="left" valign="top" background="/images/wenba_r7_c2.jpg"><table width="205" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  if(zhuanjialist!=null){
                  	for(int i=0;i<zhuanjialist.size();i++){ 
                  		if(i>=2) break;
                  		Uregister zhuanjia = (Uregister)zhuanjialist.get(i);
                  		String introduct = zhuanjia.getMemo();
                  %>
                  <tr>
                    <td width="56" align="left" valign="top"><a href="zhuanjia_info.jsp?userid=<%=zhuanjia.getId() %>&imgname=<%=zhuanjia.getImage() %>"><img src="/wenba/images/<%=zhuanjia.getImage() %>" width="56" height="78" border="0"/></a></td>
                    <td align="left" valign="top"><table width="95%" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><%=zhuanjia.getMemberid()%><br><%if(introduct!=null){ if(introduct.length()>=10) out.write(introduct.substring(0,10)+".."); else{ out.write(introduct);}}else{out.write("中国劳动法务网资深会员竭诚为您服务！");}%></td>
                      </tr>
                    </table></td>
                  </tr>  		
                  <%} }%>
