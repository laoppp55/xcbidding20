...
list = iwenba.getdifangYJJ(proname,Integer.parseInt(columnid),keyword);
...
session.setAttribute("difangyijjpagenum",String.valueOf(perpagenum));
session.setAttribute("difangyijjpagelist",pagelist);
session.setAttribute("difangyijjallpages",String.valueOf(allpages));
session.setAttribute("difangyijjthispage",String.valueOf(thispage));
response.sendRedirect("wenba_diqujj.jsp");
%>