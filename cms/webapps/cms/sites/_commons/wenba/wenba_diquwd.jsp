...
<% //最新提出问提分页
	    ...
	    List pagelist = iwenba.getProQuestionsPagenums(0,Pro);
...
function difang(prov){
	...
	{
		case '北京' :
		var url = "wenba_diqu.jsp?cid=<%=classid%>&pro=" +prov +"&keys=" +"";
		window.location.href=url;
		break;
		case '上海' :
		var url = "wenba_diqu.jsp?cid=<%=classid%>&pro=" +prov +"&keys=" +"";
                    ...
                    <tr>
                      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td align="center"><img src="/images/bai.gif" width="1" height="1" /></td>
                            <td width="247" align="center" background="/images/wenba_woyaoda_r7_c10.jpg" class="blackc12c"><a href="#" onclick="wenti_0ans_change()">零回答的问题</a></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td valign="top" background="/images/wenba_woyaoda_r8_c5.jpg"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
								...
								<%
									...
									String color = "";
									List wenti_zuixin = iwenba.getProQuestions(end_no,begin_no,0,Pro,key,classid);
                                ...
                                <tr>
                                  ...
                                  <td align="left" bgcolor="<%= color%>">
                                  	<a href="/wenba/wenba_finsh.jsp?cid=<%= wt_zuixin.getColumnid()%>&id=<%= wt_zuixin.getId()%>&fenlei=<%= lanmu%> ">&nbsp;&nbsp;<%=str%></a>&nbsp;&nbsp;
                          ...
                          <tr>
                            <td height="40" align="right" valign="bottom">
                              <%if(intPageCount>1){ %>
                            	<%if (intPage > 1) {%>
                            	<a href="wenba_diqu.jsp?page=<%=intPage - 1%>&cid=<%=classid%>&pro=<%= Pro%>"><img src="/images/wenba_woyaoda_r9_c12.jpg" width="4" height="7" border="0" align="absmiddle" /></a>&nbsp;&nbsp;
                            	<%} %>
                            	<!-- 共<%= intPageCount%>页 -->
	                    		<a href="wenba_diqu.jsp?page=1&cid=<%=classid%>&pro=<%= Pro%>">首页</a>
	                    		<%if (intPage > 1) {%>
	                    		<a href="wenba_diqu.jsp?page=<%=intPage - 1%>&cid=<%=classid%>&pro=<%= Pro%>">上一页</a><%}%>
	                    		
	                    		<%if (intPage < intPageCount) {%>
	                    		<a href="wenba_diqu.jsp?page=<%=intPage + 1%>&cid=<%=classid%>&pro=<%= Pro%>">下一页</a><%}%>
	                            <a href="wenba_diqu.jsp?page=<%=intPageCount%>&cid=<%=classid%>&pro=<%= Pro%>">尾页</a>	 &nbsp;
								<%if (intPage < intPageCount) {%>
								<a href="wenba_diqu.jsp?page=<%=intPage + 1%>&cid=<%=classid%>&pro=<%= Pro%>"><img src="/images/wenba_woyaoda_r9_c14.jpg" width="4" height="7" border="0" align="absmiddle" /></a>&nbsp;&nbsp;
								<%} %>
							  <%} %>
							</td>
                          </tr>
