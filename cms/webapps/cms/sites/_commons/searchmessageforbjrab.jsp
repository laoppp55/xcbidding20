                                                    ...
                                                    <form name="searchform" method="post" action="/_commons/searchmessageforbjrab.jsp"  onsubmit="return check_keyword();">
                                                        <tr>
                                                            <td height="50" align="left" valign="top">
                                                                关键字：<input type="text" name="keyword" size="10" maxlength="50" value="">
                                                                起始日期：<input type="text" name="sdate" size="10" maxlength="20" value="" onclick="javascript:setday(this);">
                                                                结束日期：<input type="text" name="edate" size="10" maxlength="20" value=""  onclick="javascript:setday(this);">
                                                ...
                                                <table width="690" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td height="30" align="center" valign="bottom">共<%=totalpages%>页 <a href="leavemessageforbjrab.jsp?startrow=0" class="a2">首页</a>
                                                            | <%if ((startindex - range) >= 0) {%><a href="leavemessageforbjrab.jsp?startrow=<%=startindex-range%>" class="a2">上一页</a><%}else{%>上一页<%}%> |
                                                            <%if ((startindex + range) < totalnum) {%><a href="leavemessageforbjrab.jsp?startrow=<%=startindex+range%>" class="a2">下一页</a><%}else{%>下一页<%}%>
