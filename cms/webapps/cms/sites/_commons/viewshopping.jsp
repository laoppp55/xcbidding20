...
<%
    ...
    String outstr = "";
    outstr = outstr + "<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\" bgcolor=\"#CCCCCC\" style=\"font-size:12px\" class=\"biz_table\">\n" +
            "  <tr>\n" +
    ...
    for (int i = 0; i < list.size(); i++) {
        ...
        if ((buystr != null) && (!buystr.equals("")) && (!buystr.equals("null"))) {
            ...
            "    <td align=\"center\" bgcolor=\"#FFFFFF\" style=\"font-weight:600\"><input type=\"button\" name=\"Submit\" value=\"修改\" onclick='javascript:updateCart("+productid+",document.all(\"quantity"+productid+"\").value,\""+sitename+"\")'/></td>\n" +
            "    <td align=\"center\" bgcolor=\"#FFFFFF\" style=\"font-weight:600\"><input type=\"button\" name=\"Submit22\" value=\"删除\" onClick=\"javascript:delete_shoppingcart("+productid+" ,'"+sitename+"');\"/> </td>" +
            "  </tr>";
        }
    }
    ...
    outstr = outstr +
            ...
            "  </tr><tr><td bgcolor=\"#FFFFFF\" align=right colspan=7><input type=button name=button value=结算 onClick=\"javascrip:gobuy('"+ sitename +"','" + login_to_url + "');\"></td></tr></table>";
    }else{
        outstr = "false";
    }
    out.write(outstr);
