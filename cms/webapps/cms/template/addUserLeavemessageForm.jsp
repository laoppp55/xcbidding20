...
<%
    ...
    if (doCreate) {
        ...
        content = "[TAG][LEAVEMESSAGEINFO][SITEID]"+authToken.getSiteID()+"[/SITEID][AUDITFLAG]" + auditflag + "[/AUDITFLAG][AUDITRULE]<!{^CDATA{^" + auditRule + ">^}^}>[/AUDITRULE][CONTENT]<!{^CDATA{^" + xmlstr + ">^}^}>[/CONTENT][CHINESENAME]"+cname+"[/CHINESENAME][NOTES]"+notes+"[/NOTES][/LEAVEMESSAGEINFO][/TAG]";
...
<tr height="50">
    <td align=center colspan="9">
        ...
        <input type="button" value=" 取消 " onClick = "javascript:cal();" class=tine>    </td>
</tr>
</form>
</table>
