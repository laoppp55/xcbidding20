...
<head>
    ...
    <SCRIPT LANGUAGE=JavaScript>
        ...
        function submit()
        {
          ...
          //  alert(window.dialogArguments.document.getElementById("usermodelnewsadd").value);
            ...
            if (isMSIE) {
                window.returnValue ="[CHINESENAME]"+cname+"[/CHINESENAME][WIDTH]"+width+"[/WIDTH][HEIGHT]"+height+"[/HEIGHT][ORDER]"+window.dialogArguments.document.getElementById("usermodelnewsadd").value+"[/ORDER]";
                window.close();
            } 
        }
...
<table width="96%" border="0" align=center>
    <tr height="30">
        <td>图片宽度：&nbsp;&nbsp;<input type="text" name="imgwidth" id="imgwidth" size="5">&nbsp;&nbsp;&nbsp;&nbsp;
            图片高度：&nbsp;&nbsp;<input type="text" name="imgheight" id="imgheight" size="5">
           <br> 中文名字：&nbsp;&nbsp;<input type="text" name="cname" id="cname" size="5">
