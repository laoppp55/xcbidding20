...
<script type="text/javascript">
    function checkoption() {
        ...
        optionsname[0][3] = "推荐列表";
        optionsname[0][4] = "中文路径";
        optionsname[0][5] = "英文路径";
        optionsname[0][6] = "热点文章";
        optionsname[0][7] = "相关文章";
        optionsname[0][8] = "推荐文章列表";
        optionsname[0][9] = "子文章列表";
        optionsname[0][10] = "兄弟文章列表";
        optionsname[0][11] = "子栏目列表";
        optionsname[0][12] = "文章条数";
        optionsname[0][13] = "子文章条数";
        optionsname[0][14] = "导航条";
        optionsname[0][15] = "栏目名称";
        optionsname[0][16] = "父栏目名称";
        optionsname[0][17] = "栏目URL";
        optionsname[0][18] = "公司名称";
        optionsname[0][19] = "公司联系电话";
        optionsname[0][20] = "公司邮件";
        optionsname[0][21] = "公司微博";
        optionsname[0][22] = "检索表单";
        optionsname[0][23] = "订单查询表单";
        optionsname[0][24] = "用户登录表单";
        optionsname[0][25] = "调查表单";
        optionsname[0][26] = "图片特效";
        optionsname[0][27] = "QQ号码";
        optionsname[0][28] = "加入包含文件";
        optionsname[0][29] = "最近浏览";
        optionsname[0][30] = "图片轮换效果";
        optionsname[0][31] = "用户留言表单";
        optionsname[0][32] = "用户留言列表";
        optionsname[0][33] = "用户登录页";
        optionsname[0][34] = "选择已有标记";
