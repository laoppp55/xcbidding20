...
<%
    ...
    if (doUpdate == true) {
        ...
        //out.println("</script>");
        out.println("<script type=\"text/javascript\">");
        out.println("top.opener.writeHtmlcodeMark(" + markID + ");");
        out.println("window.close()");
        out.println("</script>");
        return;
    }
    ...
    <form name=htmlmark method="post" action="editHtmlcodeMark.jsp"  onsubmit="return tijiao();">
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<input type=button name=cancel value=关闭窗口 onclick="javascript:top.window.close()">
            </td>
        </tr>
        <tr>
            <td colspan="2">
                ...
                <script type="text/javascript">
                    htmlmark.content.value = top.opener.parent.window.document.createForm.hcode.value;
                </script>
            </td>
        </tr>
    </form>
