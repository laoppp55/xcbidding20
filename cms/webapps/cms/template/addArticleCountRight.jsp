        ...
        <tr>
          <td>
            <table border="0" width="100%" cellspacing=2 cellpadding=2>
              <tr>
                <td width="73%">
                  <select id="selectedColumn" name="selectedColumn" style="width:280" size="8" language="javascript" onDblClick="defineAttr();" class=tine>
                  <%
                    if (str != null && str.trim().length() > 0)
                    {
                ...
                <td width="27%"><input type="button" name="delete" value="删除" onclick="delItem();" style="height:20;width:30;font-size:9pt"></td>
              </tr>
            </table>
          </td>
        </tr>
