...
<%
    ...
    if (doCreate) {
        ...
        String xmlstr = "[TAG][ORDEDETAIL_RESULT][SITEID]"+siteID+"[/SITEID]" +
                        "[CHINESENAME]"+cname+"[/CHINESENAME][NOTES]"+notes+"[/NOTES]" +
                        "[LISTSTYLE]<!{^CDATA{^" + content + ">^}^}>[/LISTSTYLE][/ORDEDETAIL_RESULT]"+ "[/TAG]";
...
<head>
    ...
    <script type="text/javascript">
        ...
        function doit()
        {
            var isMSIE = (navigator.appName == "Microsoft Internet Explorer");
            if (isMSIE) {
                markform.action = "addOrderDetailSearch.jsp";
    ...
    <form name="markform">
        ...
        <tr height="30">
            ...
            <td width="80%" align="left"><select id="fieldname" name="fields" onchange="SelectMarkName();">
                ...
                <option value ="card">使用购物券</option>
