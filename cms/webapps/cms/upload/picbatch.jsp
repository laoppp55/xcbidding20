...
<frameset border=0 frameborder=0 framespacing=0>
    <frame src="/webbuilder/upload/doBatchUpload.jsp?column=<%=columnID%>&template_or_article=<%=template_or_article_flag%>&articleid=<%=articleid%>" name=cmsright scrolling=auto marginheight=0 marginwidth=5 noresize>
</frameset>
</html>