                        ...
                        <tr>
                            ...
                            <td width="55%"><input type="radio" name="navPosition" value="0" <%if(navbar!=0){%>
                                ...
                                <input type="radio" name="navPosition" value="1" <%if(navbar==0){%>
                                       checked<%}%> <%if(selectWay!=2){%> disabled<%}%> onclick="selectColNavStyle();">自定义导航条位置
                            </td>
                        </tr>
                        <tr>
                            <td width="100%" colspan=2>分页导航条样式：
                                ...
                                <input type="button" id=button1 style="height:20;width:50;font-size:9pt"
                                        onclick="createStyle(2,0)" <%if (selectWay != 2 || (selectWay == 2 && navbar == 0)) {%>
                                        disabled<%}%> value="新建">
                                <input type="button" id=button2 style="height:20;width:50;font-size:9pt"
                                        onclick="updateStyle(2,navbar.options[navbar.selectedIndex].value,0)" <%if (selectWay != 2 || (selectWay == 2 && navbar == 0)) {%>
                                        disabled<%}%> value="修改">
                                <input type="button" id=button3 style="height:20;width:50;font-size:9pt"
...
<tr height="36">
    <td>列表样式：
        ...
        <input type="button" id=button4 style="height:20;width:50;font-size:9pt" onclick="createStyle(6,<%=columnID%>)" value="新建">
        <input type="button" id=button5 style="height:20;width:50;font-size:9pt"
                onclick="updateStyle(6,listType.options[listType.selectedIndex].value,<%=columnID%>)" value="修改">
        <input type="button" id=button6 style="height:20;width:50;font-size:9pt"
        ...
        <table border=0 width='100%'>
            <tr>
                <td>
                    ...
                    %>
                    <font color="#0000FF"><b>已选栏目：</b></font>
...
<tr height="50">
    <td align="center">
        <input type="button" value="  确定  " onClick="createSubColumnList();" class=tine>&nbsp;&nbsp;&nbsp;&nbsp;
