...
var MTMenuText = "<!--font class=line>WEBSITE</font-->", MTMRootIcon = "menu_new_root.gif", MTMRootColor = "#000000";
...
function MTMDisplayItem(item, last) {
    ...
    if (item.submenu) {
        ...
        var MTMouseOverCmd = "parent.status='" + (item.expanded ? "��£" : "չ��") + "';return true;";
