            ...
            <tbody>
                <tr>
                    ...
                    <td valign="top" align="left" width="767"><%@include file="/www_shwzg_com/inc/weather.shtml" %><table cellspacing="0" cellpadding="0" width="767" border="0">
                        <tbody>
                            <tr>
                                <td valign="top" align="left"><img height="218" alt="" width="767" src="/images/2010527wag-gsjj8.jpg" /></td>
                            </tr>
                            <tr>
                                <td height="30">&nbsp;</td>
                            </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="767" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td valign="bottom" align="left" height="18"><span class="titlered">免费赠书</span> <span class="entitlered">Free Book Donation</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" width="734" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                            <div style="scrollbar-face-color: #98642b; scrollbar-highlight-color: #98642b; overflow: auto; scrollbar-shadow-color: #98642b; scrollbar-arrow-color: #daae7f; scrollbar-base-color: #98642b; height: 336px; scrollbar-dark-shadow-color: #98642B">
                                            <form action="q258ckju.jsp" method="post" name="myform">
                                                <input type='hidden' name='startflag' value='1'>
                                                <input type='hidden' name='bookname' value="<%=(bookid==1)?"肿瘤防治与康复":"生命之歌"%>">
                                                <table height="72" cellspacing="1" cellpadding="1" width="700" border="0">
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input class="textbg" alt="用户名" style="width: 200px" name="username" type="text" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">电话：</td>
                                                            <td><input class="textbg" alt="电话" style="width: 120px" name="telephone" type="text" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">邮编：</td>
                                                            <td><input class="textbg" alt="邮编" style="width: 120px" name="postcode" type="text" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">地址：</td>
                                                            <td><input class="textbg" alt="地址" style="width: 230px; height: 80px" name="address" type="text" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
