...
<div class="center content-auto clearfix">
    ...
    <div class="info-content">
        <form name="releaseprod" id="releaseprodid" enctype="multipart/form-data">
            <ul>
                <li>
                    <span class="form-key"><i class="f-yellow">＊</i>商品名称：</span>
                    <input type="text" name="prodname" size="200"/>
                        ...
                        <%
                            if (columns!=null) {
                                for(int ii=0;ii<columns.size();ii++) {
                                    ...
                                    out.println("<option value=\"" + column.getID() + "\">" + column.getCNAME() + "</option>");
                                }
                            }
                        %>
                    </select>
                ...
                <li class="describe-li">
                    ...
                    <textarea name="brief" cols="" rows=""></textarea>
                ...
                <li class="upload-book">
                    ...
                    <div class="upload-book-box">
                        <div id="preview">
                            <img id="imghead" src="img/public/img-add.jpg" alt=""/>
                        </div>
...
<script>
    ...
    function doRelease() {
        var ajaxFormOption = {
            type: "post",                                                     //提交方式
            dataType: "json",                                                //数据类型
            url: "doSaveProduct.jsp?doCreate=true",       //请求url
