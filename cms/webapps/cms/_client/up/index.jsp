...
<%
    ...
    if (appContext!=null) {
        ...
        articlecount = articleService.countArticleByDeptid("长城",BigDecimal.valueOf(siteid)).intValue();
        total_pages = articlecount/pagesize;
        if (articlecount % pagesize > 0) total_pages = total_pages + 1;
        articleList = articleService.getArticleByDept("长城",BigDecimal.valueOf(siteid),startno,endno);
    }
%>
<!DOCTYPE html>
<html>
            ...
            $('.del-btn').on("click",function() {
                ...
                if (pageno>=0 && pageno<=<%=total_pages%>) {
                    if(confirm("确定要删除数据吗？")){
                        ...
                        prodform.action = "index.jsp?pageno=" + pageno;
                        prodform.submit();
                    }
                } else {
        ...
        <form name="prodform" id="prodformid">
            ...
            <div class="info-content clearfix">
                ...
                <div class="search-form">
                    商品名称：<input type="text" name="keyword" value=""/>
                    状态：
                ...
                <div class="operating">
                    ...
                    <ul class="operating-content clearfix">
                        ...
                        <li class="li-g"><%=(status==1 && pubflag==0)?"上架":"待审"%></li>
                ...
                <div class="pagination-link" style="margin:20px 0">
                    <div class="tcdPageCode">
                        <a href="index.jsp">首页</a><a href="index.jsp?pageno=<%=(pageno>1)?pageno-1:0%>">上一页</a>
                        <%
                            if (total_pages<5)
                                for(int ii=0;ii<total_pages;ii++) {
                                    out.println("<a href=\"index.jsp?pageno=" + (ii+1) + "\">" + (ii+1) + "</a>&nbsp;&nbsp;&nbsp;&nbsp;");
                                }
                        %>
                        <a href="index.jsp?pageno=<%=(pageno<total_pages)?pageno+1:total_pages%>">下一页</a><a href="index.jsp?pageno=<%=total_pages%>">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
