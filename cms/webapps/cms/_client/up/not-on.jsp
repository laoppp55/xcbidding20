...
<%
    ...
    if (appContext!=null) {
        ...
        articlecount = articleService.countRejectArticlebyDeptid("长城",BigDecimal.valueOf(1),BigDecimal.valueOf(1),BigDecimal.valueOf(2),BigDecimal.valueOf(siteid)).intValue();
        total_pages = articlecount/pagesize;
        if (articlecount % pagesize > 0) total_pages = total_pages + 1;
        articleList = articleService.getRejectArticlesbyDeptid("长城",BigDecimal.valueOf(1),BigDecimal.valueOf(1),BigDecimal.valueOf(2),BigDecimal.valueOf(siteid),startno,endno);
    }
%>
...
<head lang="en">
    ...
    <link rel="stylesheet" href="css/commodity-control/not-on.css"/>
    ...
    <script>
        $(function () {
            ...
            /*调用分页链接方法   渲染相应分页数据*/
            $('.tcdPageCode').Paging({
                pagesize: 10, count: 85, toolbar: true, callback: function (page, size, count) {
...
<div class="center content-auto clearfix">
    ...
    <div class="sidebar">
        <ul class="side-nav">
            ...
            <li class="side-nav-a select-a">
                ...
                <ul>
                    <li><a href="./index.jsp">商品信息维护</a></li>
                    <li class="select-b"><a href="./not-on.jsp">未上架的商品</a></li>
                </ul>
            </li>
            <li class="side-nav-a">
    ...
    <div class="info-box">
        <div class="info-title">
            ...
            <span>></span>
            <span><a href="javascript:void(0)">未上架的商品</a></span>
        </div>
        <div class="info-content clearfix">
            <div class="search-form">
                商品名称：<input type="text" placeholder="可通过关键词进行搜索"/>
            ...
            <div class="operating">
                ...
                <ul class="operating-content clearfix">
                    ...
                    <li class="li-g">审核未通过</li>
                    <li class="li-h">含有敏感字</li>
                    <li class="li-i"><a href="./updateproduct.jsp">修改</a></li>
                </ul>
                <%}}}%>
            </div>
