...
<table width="1002" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td align="left" valign="middle" style="background:url(/images/title_bg.jpg) no-repeat; height:29px; font-size:14px; font-weight:bold; color:#FFFFFF;"><span style="padding:3px 0px 0px 35px; display:block;">企业图片</span></td>
    </tr>
</table>
<table width="1002" border="0" cellpadding="0" cellspacing="0"style="border-right-width: 1px;border-bottom-width: 1px;border-left-width: 1px;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-right-color: #6DBE09;border-bottom-color: #6DBE09;border-left-color: #6DBE09;">
    <tr>
                    ...
                    <%
                        if ((curpage+1)*pagesize > total) {
                            for (int i=num; i<total; i++) {
                                String picurl = (String)pictures.get(i);
