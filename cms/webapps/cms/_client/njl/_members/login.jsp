            ...
            if (us==null) {
                ...
                if (password!=null) {
                    ...
                    if (!password.equalsIgnoreCase(us.getUSERPWD())) {
                        ...
                        //设置在coosite.com的二级域中都可以访问的cookie
                        SecurityUtil securityUtil = new SecurityUtil();
                        Cookie loginCookie = new Cookie("AuthInfo_cookie",securityUtil.encrypt(us.getUSERID() + "-" + us.getUSERTYPE().intValue(),null));
                        loginCookie.setDomain("coosite.com");
                        loginCookie.setPath("/");
                        response.addCookie(loginCookie);

                        if (refer_url==null) {
                            response.sendRedirect(response.encodeRedirectURL("http://" + us.getUSERID() + ".coosite.com"));
                        }else{
