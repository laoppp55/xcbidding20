...
<html>
    ...
    <style type="text/css">
<!--.biz_table{ border:0 dashed #CC3300;
 } 
.biz_table td{ font-size:12px; color:#FF3300; font-family:宋体 ; text-align:left;
}
.biz_table input{ font-size:12px;  size:10px;
                    ...
                    <table cellspacing="0" cellpadding="0" width="730" bgcolor="#ececec" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td width="730"><img height="10" alt="" width="2" align="absMiddle" border="0" src="/images/notice_bullet.gif" />&nbsp;<font style="FONT-SIZE: 12px">购物车</font></td>
                            </tr>
                        </tbody>
                    </table>
                    </td>
...
<div id="shopping"></div>
<script type="text/javascript">shoppingcart('www_chinabuy360_cn');</script>
</td>
                </tr>
            </tbody>
        </table>
