                    ...
                    <table cellspacing="0" cellpadding="0" width="730" bgcolor="#ececec" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td width="730"><img height="10" alt="" width="2" align="absMiddle" border="0" src="/images/notice_bullet.gif" />&nbsp;<font style="FONT-SIZE: 12px"><strong>订单查询</strong></font></td>
                            </tr>
                        </tbody>
                    </table>
                    </td>
...
<script type="text/javascript">getUerOrderList('www_chinabuy360_cn');</script></td>
                            </tr>
                        </tbody>
                    </table>
                    </td>
