...
function check()
{
    ...
    else
    {
        ...
        retstr = "yes";
        var str = cname.value+"(_"+e_name+")<textarea Editor id='[BIZWINK_ID]"+cname.value+"--"+datatype.value+"[/BIZWINK_ID]' name='[BIZWINK_NAME]_"+e_name+"[/BIZWINK_NAME]' rows=5 cols=20></textarea><input type=button value=编辑 onclick=Editor('_"+e_name+"');>";
        if (key.checked)
...
<table border="0" width="100%">
    ...
    <tr height=25>
      ...
      <td><select name=datatype style="width:110"><option value=1>字符串型</option><option value=3>文本型</option>/td>
    </tr>
    <tr height=25>
