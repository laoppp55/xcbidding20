...
function check()
{
    ...
    else
    {
        ...
        retstr = "yes";
        var str = cname.value+"(_"+e_name+")<textarea id='[BIZWINK_ID]"+cname.value+"--"+datatype.value+"[/BIZWINK_ID]' name='[BIZWINK_NAME]_"+e_name+"[/BIZWINK_NAME]' rows=5 cols=20></textarea>";
        if (key.checked)
