    ...
    else
    {
        ...
        if (tempstr.length > 0)
        {
            ...
            for (var i=0; i<arr.length; i++)
            {
            	...
            	str = str + "<input id='[BIZWINK_ID]"+cname.value+"--"+datatype.value+"[/BIZWINK_ID]' type=radio name='[BIZWINK_NAME]_"+e_name+"[/BIZWINK_NAME]' value="+arr[i]+">" + arr[i];
            }
        }
...
<table border="0" width="100%">
    ...
    <tr>
      <td valign=top><p align="right">单选按钮选项：（"/"隔开）</p></td>
