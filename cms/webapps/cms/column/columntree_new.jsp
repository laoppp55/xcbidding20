                ...
                <TABLE border=0 cellpadding=0 cellspacing=0 width=100%>
                    <tr id=d01>
                        <td height=20 class=MouseOut
                            onMouseOver="this.className='MouseOver';" onMouseOut="this.className='MouseOut';">&nbsp;创建子栏目
                        </td>
                    </tr>
                    <tr id=d02>
                        <td height=20 class=MouseOut
                            onMouseOver="this.className='MouseOver';" onMouseOut="this.className='MouseOut';">&nbsp;修改栏目
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr id=d03>
                        <td height=20 class=MouseOut
                            onMouseOver="this.className='MouseOver';" onMouseOut="this.className='MouseOut';">&nbsp;删除栏目
                        </td>
                    </tr>
                    <tr id=d04>
                        <td height=20 class=MouseOut
                            onMouseOver="this.className='MouseOver';" onMouseOut="this.className='MouseOut';">&nbsp;创建全站扩展属性
                        </td>
                    </tr>
                    <tr id=d05>
                        <td height=20 class=MouseOut
                            onMouseOver="this.className='MouseOver';" onMouseOut="this.className='MouseOut';">&nbsp;创建全站审核规则
                        </td>
                    </tr>
                    <tr id=d06>
                        <td height=20 class=MouseOut
