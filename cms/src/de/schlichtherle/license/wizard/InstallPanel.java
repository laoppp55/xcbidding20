 ...
 * InstallPanel.java
 *
 * Created on 20. Februar 2005, 16:59
 */
/*
...
public class InstallPanel extends javax.swing.JPanel {
    ...
    private void updateFileField() {
        ...
        installButton.setEnabled(fileName != null && new java.io.File(fileName).isFile());
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        prompt.setText(Resources.getString("InstallPanel.prompt.text", new Object[] {manager.getLicenseParam().getSubject()
        }));
        ...
        installButton.setText(Resources.getString("InstallPanel.installButton.text"));
