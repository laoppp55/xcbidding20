...
public class LicenseManager implements LicenseCreator, LicenseVerifier {
     ...
     */
    protected synchronized void store(final LicenseContent content, final LicenseNotary notary, final File keyFile) throws Exception {
     ...
     *     parameters, 'consumerType' must also match (whereby case
