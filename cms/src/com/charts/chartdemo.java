...
//public class chartdemo{
    ...
    /*public static String generateDemo(HttpSession session, PrintWriter pw) {
    ...
    public static void main(String[] args) {
        chartdemo demo = new chartdemo("JFreeChart : CombinedXYPlotDemo1");
        demo.pack();
