...
public class CmsSetup {
    ...
    /** Contains the properties from the cms.properties file */
    ...
    public void initProperties(String props)  {
        ...
        //System.out.print(getConfigFolder());
        try {
            ...
            // m_dbSetupProps.load(getClass().getClassLoader().getResourceAsStream("com/bizwink/boot/dbsetup.properties"));
            m_dbSetupProps.load(fisdb);
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public String getResourceBroker() {
        Object temp =  m_extProp.get("main.db.type");
        if(temp != null)  {
    ...
    public Vector getResourceBrokerNames() {
        ...
        String value = m_dbSetupProps.getProperty("resourceBrokerNames");
        StringTokenizer tokenizer = new StringTokenizer(value, ",");
        while (tokenizer.hasMoreTokens()) {
    ...
    public String getDbWorkUser()  {
        Object ConStr =  m_extProp.get("main.db.username");
        if(ConStr != null)  {
            return m_extProp.get("main.db.username").toString();
        }
        else  {
            return "";
        }
    ...
    public String getDbDriver() {
        return m_extProp.get("main.db.driver").toString();
    }
    ...
    /** Sets the config value for property */
    public void setConfigProperty(String configProperty)  {
        setProperties("main.db",configProperty);
    }

    /** Returns the config value for property */
    public String getConfigProperty()  {
        Object temp =  m_extProp.get("main.db.");
        if(temp != null)  {
            return temp.toString();
        }
        else  {
    ...
    public void SetDbMain(String type,String driver,String dbWorkConStr,String dbWorkUser,String dbWorkPwd)  {
        setProperties("main.db.type",type);
        setProperties("main.db.driver",driver);
        setProperties("main.db.url",dbWorkConStr);
        setProperties("main.db.username",dbWorkUser);
        setProperties("main.db.password",dbWorkPwd);
    }
