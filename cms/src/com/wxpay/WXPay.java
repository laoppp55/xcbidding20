...
public class WXPay {
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        //String reqBody = MapXMLUtil.mapToXml(reqData);
        System.out.println(urlSuffix);
        System.out.println(msgUUID);
        System.out.println(reqBody);
        System.out.println(connectTimeoutMs);
        System.out.println(readTimeoutMs);
        System.out.println(readTimeoutMs);
        System.out.println(autoReport);
     ...
     * @throws Exception
     */
    public String requestQueryWithoutCert(String urlSuffix, Map<String, String> reqData,
                                     int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String msgUUID = reqData.get("nonce_str");
        //String reqBody = WXPayUtil.mapToXml(reqData);
        String reqBody = MapXMLUtil.mapToXml(reqData);
     ...
     * @throws Exception
     */
    public Map<String, String> processQueryResponseXml(String xmlStr) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = MapXMLUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
            return_code = respData.get(RETURN_CODE);
        } else {
            throw new Exception(String.format("No `return_code` in XML: %s", xmlStr));
    ...
    public Map<String, String> orderQuery(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
       ...
       // System.out.println(reqData);
        ...
        String respXml = this.requestQueryWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processQueryResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    public Map<String, String> orderQueryCmd(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_ORDERQUERY_URL_SUFFIX;
        }
